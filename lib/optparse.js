(function(){
  ...
  exports.OptionParser = (function(){
    var _ref;
    function _ctor(){} _ctor.prototype = OptionParser.prototype;
    function OptionParser(it){
      var _this = new _ctor;
      _this.rules = it.map(function(_arg){
        var description, hasArg, isList, longFlag, shortFlag, _ref;
        shortFlag = _arg[0], longFlag = _arg[1], description = _arg[2];
        _ref = LONG_FLAG.exec(longFlag), longFlag = _ref[0], hasArg = _ref[1], isList = _ref[2];
        return {
    ...
    _ref.parse = function(args, options){
      var arg, i, rule, value, _i, _len, _len2, _name, _ref;
