(function(){
  ...
  exports.OptionParser = (function(){
    ...
    OptionParser.prototype.help = function(){
      var lf, lines, pad, rule, sf, width, _i, _len, _ref, _result;
  ...
  normalizeArguments = function(args){
    var arg, l, match, results, _i, _j, _len, _len2, _ref, _result, _result2, _this;
    results = (function(){
      _result = [];
    ...
    return (_this = []).concat.apply(_this, results);
  };
}).call(this);
