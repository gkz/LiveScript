...
bnf = {
  ...
  Expression: [
    o('Chain', function(){
      ...
      return Op($2, $1, $3);
    }), o('Expression COMPARE  Expression', op), o('Expression LOGIC    Expression', op), o('Expression MATH     Expression', op), o('Expression SHIFT    Expression', op), o('Expression BITWISE  Expression', op), o('Expression **       Expression', op), o('Expression RELATION Expression', function(){
      return ('!' === $2.charAt(0)
...
operators = [['left', 'POST_IF', 'FOR', 'WHILE'], ['right', 'IF', 'ELSE', 'SWITCH', 'CASE', 'DEFAULT', 'CLASS', 'FORIN', 'FOROF', 'FROM', 'TO', 'BY'], ['right', ':', 'ASSIGN', 'HURL', 'EXTENDS', 'INDENT'], ['right', 'LOGIC'], ['left', 'BITWISE'], ['right', 'COMPARE'], ['left', 'RELATION'], ['left', 'SHIFT', 'IMPORT'], ['left', '+-'], ['left', 'MATH'], ['right', 'UNARY'], ['right', '**'], ['nonassoc', 'CREMENT']];
tokens = (function(){
