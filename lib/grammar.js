(function(){
  ...
  grammar = {
    ...
    Expression: [o('Value'), o('Call'), o('Function'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class')],
    Block: [
    ...
    Call: [
      o('Value OptFuncExist Arguments', function(){
        ...
        return Call('super', [Splat(Literal('arguments'))]);
