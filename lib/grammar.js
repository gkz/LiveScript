...
operators = [['left', 'POST_IF', 'FOR', 'WHILE'], ['right', 'SWITCH', 'CASE', 'TO', 'BY'], ['right', 'ASSIGN', 'HURL', 'EXTENDS', 'INDENT'], ['right', 'LOGIC'], ['left', 'BITWISE'], ['right', 'COMPARE'], ['left', 'RELATION'], ['left', 'SHIFT', 'IMPORT'], ['left', '+-'], ['left', 'MATH'], ['right', 'UNARY'], ['nonassoc', 'CREMENT']];
tokens = (function(){
