...
bnf = {
  ...
  Expression: [
    o('Chain', function(){
      ...
      return Return($2);
    }), o('RETURN INDENT ArgList OptComma DEDENT', function(){
      return Return(Arr.maybe($3));
    }), o('RETURN', function(){
      return L(Return());
    }), o('JUMP', function(){
      return L(new Jump($1));
      ...
      return new Throw($2);
    }), o('THROW INDENT ArgList OptComma DEDENT', function(){
      return new Throw(Arr.maybe($3));
    }), o('THROW', function(){
      return L(new Throw);
...
operators = [['left', 'POST_IF', 'FOR', 'WHILE'], ['right', 'IF', 'ELSE', 'SWITCH', 'CASE', 'DEFAULT', 'CLASS', 'FORIN', 'FOROF', 'FROM', 'TO', 'BY'], ['right', ':', 'ASSIGN', 'RETURN', 'THROW', 'EXTENDS', 'INDENT'], ['right', 'LOGIC'], ['left', 'BITWISE'], ['right', 'COMPARE'], ['left', 'RELATION'], ['left', 'SHIFT', 'IMPORT'], ['left', '+-'], ['left', 'MATH'], ['right', 'UNARY'], ['nonassoc', 'CREMENT']];
tokens = (function(){
