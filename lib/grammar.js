(function(){
  ...
  grammar = {
    ...
    LoopHead: [
      ...
      }), o('FOR ALL IDENTIFIER              FORIN Expression', function(){
        return mix(For(), {
          object: true,
          index: $3,
          source: $5
        });
      }), o('FOR ALL IDENTIFIER , Assignable FORIN Expression', function(){
        return mix(For(), {
          object: true,
          index: $3,
          name: $5,
