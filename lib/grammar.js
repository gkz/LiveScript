(function(){
  ...
  grammar = {
    ...
    Statement: [
      o('Comment'), o('Return'), o('Throw'), o('STATEMENT', function(){
        return Literal($1);
      })
    ],
    Expression: [o('Value'), o('Call'), o('Function'), o('Operation'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class')],
    Block: [
    ...
    ThisProperty: [
      o('THISPROP', function(){
        return Value(Literal('this'), [Accessor(Literal($1))], 'this');
      })
    ],
    OptComma: [o(''), o(',')],
    Object: [
    ...
    Call: [
      o('Value OptFuncExist Arguments', function(){
        return Call($1, $3, $2);
      }), o('Call  OptFuncExist Arguments', function(){
        return Call($1, $3, $2);
      }), o('SUPER', function(){
        return Call(null, [Splat(Literal('arguments'))]);
    ...
    Loop: [
      o('LOOP Block', function(){
        return While(Literal(true)).addBody($2);
      }), o('LOOP Expression', function(){
        return While(Literal(true)).addBody(Expressions($2));
      })
    ],
    For: [
