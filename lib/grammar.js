...
bnf = {
  ...
  Line: [
    o('Expression'), o('LABEL Expression', function(){
      return new Label($1, $2);
    }), o('PARAM( ArgList OptComma )PARAM BACKCALL Expression', function(){
  ...
  LoopHead: [
    ...
    }), o('FOR OWN IDENTIFIER              FORIN Expression', function(){
      return new For({
        object: true,
        own: true,
        index: $3,
    ...
    }), o('FOR OWN IDENTIFIER , Assignable FORIN Expression', function(){
      return new For({
        object: true,
        own: true,
        index: $3,
