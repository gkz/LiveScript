(function(){
  var unwrap, o, grammar, operators, name, alternatives, alt, token, tokens;
  ...
  o = function(patterns, action, options){
    ...
    action = (that = unwrap.exec(action))
      ? that[1]
      : "(" + action + "())";
    action = action.replace(/\b(?:[A-Z][\w.]+|mix\b)/g, 'yy.$&');
  ...
  grammar = {
    ...
    Value: [
      o('Assignable', function(){
        ...
        return Value(Util.Clone($1.unwrap(), $3));
      })
    ],
    SimpleAssignable: [
      o('IDENTIFIER', function(){
        ...
        return $1.add(Access(Literal($3), $2));
      }), o('Value ACCESS STRNUM', function(){
        return $1.add(Index(Literal($3), $2));
      }), o('Value ACCESS Parenthetical', function(it){
    ...
    ThisProperty: [
      o('THISPROP', function(){
        return Value(Literal('this'), [Access(Literal($1))], true);
      })
    ],
    Parenthetical: [
      o('(        Body        )', function(){
    ...
    Fun: [
      o('PARAM_START ArgList OptComma PARAM_END\
    ...
    AssignObj: [
      o('ObjAssignable :        Expression', function(){
        ...
        return Splat($2);
      }), o('PLUS_MINUS ObjAssignable', function(){
  ...
  operators = [['nonassoc', 'CREMENT'], ['left', '?'], ['right', 'UNARY'], ['left', 'MATH'], ['left', 'PLUS_MINUS'], ['left', 'SHIFT', 'IMPORT'], ['left', 'RELATION'], ['left', 'COMPARE'], ['left', 'LOGIC'], ['right', ':', 'ASSIGN', 'COMPOUND_ASSIGN', 'RETURN', 'THROW', 'EXTENDS', 'INDENT'], ['right', 'IF', 'ELSE', 'SWITCH', 'CASE', 'DEFAULT', 'CLASS', 'FORIN', 'FOROF', 'FROM', 'TO', 'BY'], ['left', 'POST_IF', 'FOR', 'WHILE']];
  tokens = (function(){
