...
bnf = {
  ...
  Expression: [
    o('Chain', function(){
      ...
      return $2.named($1);
    }), o('FUNCTION ( ArgList OptComma ) Block', function(){
      return L(Fun($3, $6).named($1));
    }), o('FUNCTION                      Block', function(){
      return L(Fun([], $2).named($1));
...
operators = [['left', 'POST_IF', 'FOR', 'WHILE'], ['right', 'IF', 'ELSE', 'SWITCH', 'CASE', 'DEFAULT', 'CLASS', 'FORIN', 'FOROF', 'FROM', 'TO', 'BY'], ['right', ':', 'ASSIGN', 'HURL', 'EXTENDS', 'INDENT'], ['right', 'LOGIC'], ['left', 'BITWISE'], ['right', 'COMPARE'], ['left', 'RELATION'], ['left', 'SHIFT', 'IMPORT'], ['left', '+-'], ['left', 'MATH'], ['right', 'UNARY'], ['nonassoc', 'CREMENT']];
tokens = (function(){
