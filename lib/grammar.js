(function(){
  ...
  grammar = {
    ...
    ForOf: [
      ...
      }), o('FOROF Expression BY Expression WHEN Expression', function(){
        return mix(For(), {
          source: $2,
          step: $4,
          guard: $6
    ...
    LoopHead: [
      o('FOR Assignable              ForOf', function(){
        return mix($3, {
          name: $2
        });
      }), o('FOR Assignable , IDENTIFIER ForOf', function(){
        return mix($5, {
          name: $2,
          index: $4
        });
       ...
       ForIn', function(){
      ...
      }), o('FOR IDENTIFIER FROM Expression TO Expression WHEN Expression', function(){
        return mix(For(), {
          index: $2,
          from: $4,
          op: $5,
        ...
        BY Expression WHEN Expression', function(){
        return mix(For(), {
          index: $2,
          from: $4,
          op: $5,
