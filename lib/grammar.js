(function(){
  ...
  grammar = {
    ...
    Expression: [o('Value'), o('Call'), o('Function'), o('Operation'), o('If'), o('Try'), o('Loop'), o('Switch'), o('Class')],
    Block: [
