...
bnf = {
  ...
  Expression: [
    o('Chain', function(){
      ...
      return Binary($2, $1, $3);
    }), o('Expression COMPARE Expression', ditto), o('Expression LOGIC   Expression', ditto), o('Expression MATH    Expression', ditto), o('Expression ^       Expression', ditto), o('Expression POWER   Expression', ditto), o('Expression SHIFT   Expression', ditto), o('Expression BITWISE Expression', ditto), o('Expression CONCAT  Expression', ditto), o('Expression RELATION Expression', function(){
      return '!' === $2.charAt(0)
  ...
  LoopHead: [
    ...
    }), o('FOR Chain IN Expression WHEN Expression', function(){
      return new For({
        item: $2.unwrap(),
        index: $3,
        source: $4,
    ...
    }), o('FOR Chain IN Expression BY Expression WHEN Expression', function(){
      return new For({
        item: $2.unwrap(),
        index: $3,
        source: $4,
    ...
    }), o('FOR     ID         OF Expression WHEN Expression', function(){
      return new For({
        object: true,
        index: $2,
        source: $4,
    ...
    }), o('FOR     ID , Chain OF Expression WHEN Expression', function(){
      return new For({
        object: true,
        index: $2,
        item: $4.unwrap(),
    ...
    }), o('FOR OWN ID         OF Expression WHEN Expression', function(){
      return new For({
        object: true,
        own: true,
        index: $3,
    ...
    }), o('FOR OWN ID , Chain OF Expression WHEN Expression', function(){
      return new For({
        object: true,
        own: true,
        index: $3,
    ...
    }), o('FOR ID FROM Expression TO Expression WHEN Expression', function(){
      return new For({
        index: $2,
        from: $4,
        op: $5,
    ...
    }), o('FOR ID FROM Expression TO Expression BY Expression WHEN Expression', function(){
      return new For({
        index: $2,
        from: $4,
        op: $5,
    ...
    }), o('WHILE Expression , Expression WHEN Expression', function(){
...
operators = [['left', 'PIPE', 'POST_IF', 'FOR', 'WHILE'], ['right', ',', 'ASSIGN', 'HURL', 'EXTENDS', 'INDENT', 'SWITCH', 'CASE', 'TO', 'BY', 'WHEN', 'LABEL'], ['right', 'CONCAT'], ['right', 'LOGIC'], ['left', 'BITWISE'], ['right', 'COMPARE'], ['left', 'RELATION'], ['left', 'SHIFT', 'IMPORT'], ['left', '+-'], ['left', 'MATH'], ['right', 'UNARY'], ['right', 'POWER', '^'], ['nonassoc', 'CREMENT']];
tokens = (function(){
