  ...
  grammar = {
    ...
    Expression: [
      o('Value'), o('Code'), o('FUNCTION Code', function(){
        ...
        return $2.charAt(0) === '!' ? Op($2.slice(1), $1, $3).invert() : Op($2, $1, $3);
    ...
    SimpleAssignable: [
      o('Identifier'), o('ThisProperty'), o('Value ACCESS Identifier', function(){
        return $1.append(Access($3, $2));
    ...
    Value: [
      o('THIS', function(){
        ...
        return Value($1 === 'void' ? Op('void', Literal(8)) : Literal($1));
