...
operators = [['left', 'POST_IF', 'FOR', 'WHILE'], ['right', 'IF', 'ELSE', 'SWITCH', 'CASE', 'DEFAULT', 'CLASS', 'FORIN', 'FOROF', 'FROM', 'TO', 'BY'], ['right', ':', 'ASSIGN', 'HURL', 'EXTENDS', 'INDENT'], ['right', 'LOGIC'], ['left', 'BITWISE'], ['right', 'COMPARE'], ['left', 'RELATION'], ['left', 'SHIFT', 'IMPORT'], ['left', '+-'], ['left', 'MATH'], ['left', '**'], ['right', 'UNARY'], ['nonassoc', 'CREMENT']];
tokens = (function(){
