(function(){
  var BANNER, Coco, OptionParser, SWITCHES, compileScript, compileScripts, compileStdio, die, exec, fs, o, oparser, parseOptions, path, printTokens, sources, spawn, usage, version, watch, writeJs, _ref, __importAll = function(obj, src){
