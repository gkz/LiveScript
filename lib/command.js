(function(){
  var Coco, fs, path, oparser, o, sources, compileScripts, compileScript, compileStdio, watch, writeJs, printTokens, repl, help, version, __importAll = function(obj, src){ for (var key in src) obj[key] = src[key]; return obj }, __bind = function(me, fn){ return function(){ return fn.apply(me, arguments) } };
