var o, sources, compileScripts, compileScript, compileStdin, watch, writeJs, printTokens, repl, forkNode, help, version, __importAll = function(obj, src){ for (var key in src) obj[key] = src[key]; return obj }, __slice = [].slice, __import = function(obj, src){
...
repl = function(){
  var Script, context, readline, stdin, buf, repl, _ref;
