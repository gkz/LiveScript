...
var LiveScript, path, fs, util, prelude, each, breakList, lines, unlines, take, ref$, parseOptions, generateHelp, nameFromPath, SourceNode, version, slice$ = [].slice, toString$ = {}.toString;
LiveScript = require('..');
path = require('path');
fs = require('fs');
util = require('util');
prelude = require('prelude-ls'), each = prelude.each, breakList = prelude.breakList, lines = prelude.lines, unlines = prelude.unlines, take = prelude.take;
...
(function(it){
  ...
  var ref$, say, sayWithTimestamp, warn, die, p, pp, ppp, fileExists, o, positional, e, validMapValues, toInsert, that, filename, jsonCallback;
  ref$ = arg$ != null
    ? arg$
