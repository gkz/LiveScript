...
var LiveScript, path, fs, util, prelude, each, breakList, ref$, parseOptions, generateHelp, nameFromPath, SourceNode, version, slice$ = [].slice;
LiveScript = require('..');
path = require('path');
fs = require('fs');
util = require('util');
...
(function(it){
  ...
  var ref$, say, warn, die, p, pp, ppp, o, positional, e, validMapValues, toInsert, that, filename;
  ref$ = arg$ != null
    ? arg$
    : {}, say = ref$.say, warn = ref$.warn, die = ref$.die;
