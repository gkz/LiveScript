...
var LiveScript, path, fs, util, prelude, each, breakList, keys, filter, dasherize, map, ref$, parseOptions, generateHelp, nameFromPath, SourceNode, version, slice$ = [].slice, toString$ = {}.toString;
LiveScript = require('..');
path = require('path');
fs = require('fs');
util = require('util');
prelude = require('prelude-ls'), each = prelude.each, breakList = prelude.breakList, keys = prelude.keys, filter = prelude.filter, dasherize = prelude.dasherize, map = prelude.map;
...
(function(it){
  ...
  var ref$, say, sayWithTimestamp, warn, die, p, pp, ppp, dasherizeVars, startsWith, o, positional, e, validMapValues, toInsert, that, filename, jsonCallback;
  ref$ = arg$ != null
    ? arg$
