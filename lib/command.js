(function(){
  var Coco, fs, path, oparser, o, sources, compileScripts, compileScript, compileStdio, watch, writeJs, printTokens, repl, help, version, __importAll = function(obj, src){ for (var key in src) obj[key] = src[key]; return obj }, __slice = Array.prototype.slice, __bind = function(me, fn){ return function(){ return fn.apply(me, arguments) } };
  ...
  exports.run = function(){
    ...
    (_ref = process.argv).splice.apply(_ref, [2, 1 / 0].concat(__slice.call(args)));
