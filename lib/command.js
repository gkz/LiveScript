(function(){
  var BANNER, Coco, OptionParser, SWITCHES, compileOptions, compileScript, compileScripts, compileStdio, exec, fs, lint, oparser, opts, parseOptions, path, printTokens, sources, spawn, usage, version, watch, writeJs, _ref, __importAll = function(obj, src){
