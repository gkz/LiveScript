...
var LiveScript, path, fs, util, prelude, each, breakList, ref$, parseOptions, generateHelp, nameFromPath, version, this$ = this, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
LiveScript = require('..');
path = require('path');
fs = require('fs');
util = require('util');
