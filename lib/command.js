(function(){
  var BANNER, Coco, EventEmitter, OptionParser, SWITCHES, compileOptions, compileScript, compileScripts, compileStdio, exec, fs, lint, optionParser, opts, parseOptions, path, printTokens, sources, spawn, usage, version, watch, writeJs, _ref, __importAll = function(obj, src){
  ...
  __importAll(Coco, EventEmitter.prototype);
