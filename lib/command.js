(function(){
  var BANNER, Coco, OptionParser, SWITCHES, compileScript, compileScripts, compileStdio, die, exec, fs, o, oparser, parseOptions, path, printTokens, say, sources, spawn, usage, version, warn, watch, writeJs, _ref, __importAll = function(obj, src){
  ...
  exports.run = function(){
    ...
    if (!sources.length) {
      return (version(), usage(), require('./repl'));
    }
