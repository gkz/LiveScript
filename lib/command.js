...
function repl(){
  var repl, code, cont, stdin, reset, prompt, vm, _ttyWrite, _ref;
  code = '';
  cont = false;
  ...
  if (!o.compile) {
    ...
    global.require = require;
    repl.completer = __bind(_ref = (_ref = __clone(require('repl').REPLServer.prototype), _ref.context = global, _ref.commands = [], _ref), _ref.complete);
  }
