(function(){
  var BANNER, Coco, OptionParser, SWITCHES, compileScript, compileScripts, compileStdio, exec, fs, help, o, oparser, path, printTokens, repl, sources, spawn, version, watch, writeJs, _ref, __bind = function(me, fn){ return function(){ return fn.apply(me, arguments); }; }, __importAll = function(obj, src){
