define('ace/mode/coco', function(require, exports, module){
  var identifier, LiveScriptMode, keywordend, stringfill;
  identifier = '(?!\\d)(?:(?!\\s)[\\w$\\xAA-\\uFFDC])+';
  exports.Mode = LiveScriptMode = (function(superclass){
    LiveScriptMode.displayName = 'LiveScriptMode';
    var indenter, prototype = __extend(LiveScriptMode, superclass).prototype, constructor = LiveScriptMode;
    ...
    prototype.checkOutdent = function(state, line, input){
      var __ref;
      return (__ref = this.$outdent) != null ? __ref.checkOutdent(line, input) : void 8;
    };
    prototype.autoOutdent = function(state, doc, row){
      var __ref;
      return (__ref = this.$outdent) != null ? __ref.autoOutdent(doc, row) : void 8;
    };
  ...
  LiveScriptMode.Rules = {
    start: [
      {
        token: 'keyword',
        regex: '(?:t(?:h(?:is|row|en)|ry|ypeof!?)|c(?:on(?:tinue|st)|a(?:se|tch)|lass)|i(?:n(?:stanceof)?|mport(?:\\s+all)?|[fs])|d(?:e(?:fault|lete|bugger)|o)|f(?:or(?:\\s+own)?|inally|unction)|s(?:uper|witch)|e(?:lse|x(?:tends|port)|val)|a(?:nd|rguments)|n(?:ew|ot|o)|un(?:less|til)|w(?:hile|ith)|o[frn]|off|return|break|let|var|loop|yes)' + keywordend
      }, {
