...
(Node = function(){
  ...
  cache: function(o, once, level){
    var ref, sub, _ref;
    if (!this.isComplex()) {
      return [_ref = level != null ? this.compile(o, level) : this, _ref];
    }
  ...
  eachChild: function(fn){
    var name, child, i, node, that, _i, _ref, _len, _len2;
    for (_i = 0, _len = (_ref = this.children).length; _i < _len; ++_i) {
      name = _ref[_i];
      if (child = this[name]) {
        if ('length' in child) {
          for (i = 0, _len2 = child.length; i < _len2; ++i) {
            node = child[i];
  ...
  traverseChildren: function(fn, xscope){
    ...
    return this.eachChild(function(node, name, index){
      var _ref;
      return (_ref = fn(node, _this, name, index)) != null
        ? _ref
...
exports.Obj = Obj = (function(superclass){
  ...
  prototype.compileNode = function(o){
    var items, code, idt, dic, i, node, logic, rest, multi, key, val, temp, _len;
    items = this.items;
    if (!items.length) {
      return this.front ? '({})' : '{}';
    }
...
exports.Unary = Unary = (function(superclass){
  ...
  function Unary(op, it, flag){
    var that, node, _i, _ref, _len, _this = this instanceof _ctor ? this : new _ctor;
  ...
  prototype.compileNode = function(o){
    ...
    for (i = 0, _len = items.length; i < _len; ++i) {
      ...
      if (test instanceof Splat) {
        code += (_ref = new In(Var(ref), test.it), _ref.negated = this.negated, _ref).compile(o, LEVEL_TOP);
        if (!(i || sub === ref)) {
          code = "(" + sub + ", " + code + ")";
        }
      } else {
...
exports.Fun = Fun = (function(superclass){
  ...
  prototype.compileParams = function(scope){
    var params, body, names, assigns, i, p, splace, rest, that, dic, vr, df, v, name, temp, _len, _i, _ref, _ref2;
...
exports.Class = Class = (function(superclass){
  ...
  prototype.compile = function(o, level){
    var fun, title, decl, name, lines, i, node, proto, ctor, vname, that, args, clas, _len, _ref;
...
exports.For = For = (function(superclass){
  ...
  prototype.compileNode = function(o){
    var temps, idx, pvar, step, tvar, tail, vars, eq, cond, svar, srcPart, lvar, head, body, _ref;
    o.loop = true;
    temps = this.temps = [];
    if (idx = this.index) {
      o.scope.declare(idx);
