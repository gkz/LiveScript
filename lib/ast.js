...
exports.Slice = Slice = (function(superclass){
  ...
  prototype.compileNode = function(o){
    return util('slice') + ".call(" + this.target.compile(o) + ", " + this.from.compile(o) + "" + (this.to ? ',' + this.to.compile(o) + (this.type === 'to' ? ' + 1' : '') : '') + ")";
  };
  return Slice;
}(Node));
...
exports.Assign = Assign = (function(superclass){
  ...
  prototype.compileSplice = function(o){
    ...
    if (this.left.type === 'to') {
      toExp = Binary('+', toExp, Literal('1'));
    }
