...
exports.Switch = Switch = (function(superclass){
  ...
  prototype.compileNode = function(o){
    var tab, ref$, targetNode, target, topic, code, stop, i$, len$, i, c, that;
    tab = this.tab;
    if (this.target) {
    ...
    for (i$ = 0, len$ = (ref$ = this.cases).length; i$ < len$; ++i$) {
      i = i$;
      c = ref$[i$];
      code += c.compileCase(o, tab, i === stop, !topic, target);
    }
    if (this['default']) {
      o.indent = tab + TAB;
...
exports.Case = Case = (function(superclass){
  ...
  prototype.compileCase = function(o, tab, nobr, bool, type, target){
    var tests, i$, ref$, len$, test, j$, ref1$, len1$, t, i, that, code, lines, last, ft;
    tests = [];
