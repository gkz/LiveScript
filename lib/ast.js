    ...
    for (i = 0, _len = (_ref = this.tails).length; i < _len; ++i) {
      ...
      if (node.soak) {
        ...
        test = node instanceof Call
          ? ((_ref2 = Chain(this.head, this.tails.splice(0, i)).cacheReference(o), test = _ref2[0], this.head = _ref2[1], _ref2), JS("typeof " + test.compile(o, LEVEL_OP) + " == 'function'"))
          : ((_ref2 = Chain(this.head, this.tails.splice(0, i)).unwrap().cache(o, true), test = _ref2[0], this.head = _ref2[1], _ref2), Existence(test));
