...
exports.Chain = Chain = (function(superclass){
  ...
  prototype.compileNode = function(o){
    var head, tails, args, code, i, a, that, base, rest, news, t, __len, __i, __ref;
    if (this.flip) {
      util('flip');
      util('curry');
    }
    ...
    if (tails[0] instanceof Call && tails[0].partialized) {
      util('slice');
      args = tails[0].args;
      code = util('partialize') + "(" + this.head.compile(o, LEVEL_LIST) + ", [";
...
exports.Binary = Binary = (function(superclass){
  ...
  prototype.compilePartial = function(o){
    var xRef, x, yRef, y;
    x = Chain(Var(xRef = o.scope.temporary('x')));
    switch (false) {
    case !(this.first == null && this.second == null):
      y = Chain(Var(yRef = o.scope.temporary('y')));
      return util('curry') + "(function(" + xRef + ", " + yRef + "){ return " + Binary(this.op, x, y).invertCheck(this).compile(o) + "; })";
    case this.first == null:
      return "(function(" + xRef + "){ return " + Binary(this.op, this.first, x).invertCheck(this).compile(o) + "; })";
    default:
      return "(function(" + xRef + "){ return " + Binary(this.op, x, this.second).invertCheck(this).compile(o) + ";})";
    }
  };
  return Binary;
}(Node));
