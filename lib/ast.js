...
exports.Unary = Unary = (function(_super){
  ...
  var prototype = __extends(Unary, _super).prototype, constructor = Unary;
  function _ctor(){} _ctor.prototype = prototype;
  function Unary(op, it, post){
...
exports.Binary = Binary = (function(_super){
  ...
  var EQUALITY, COMPARER, prototype = __extends(Binary, _super).prototype, constructor = Binary;
  function _ctor(){} _ctor.prototype = prototype;
...
exports.Parens = Parens = (function(_super){
  ...
  prototype.compile = function(o, level){
    ...
    if (!(this.keep || this.newed || it instanceof Binary && level >= LEVEL_OP + PREC[it.op] || it instanceof Unary && level >= LEVEL_OP + PREC.unary)) {
...
exports.If = If = (function(_super){
  ...
  prototype.compileExpression = function(o){
    var thn, lse, code, pad;
    thn = this.then, lse = this['else'];
    this['void'] && (thn['void'] = (lse || 0)['void'] = true);
    if (!lse && (this.cond || this['void'])) {
      return Parens(Binary('&&', this['if'], thn)).compile(o);
    }
    code = this['if'].compile(o, LEVEL_COND);
    pad = lse != null && lse.isComplex() ? '\n' + (o.indent += TAB) : ' ';
    code += pad + "? " + thn.compile(o, LEVEL_LIST) + "" + pad + ": " + ((lse != null ? lse.compile(o, LEVEL_LIST) : void 8) || 'void 8');
