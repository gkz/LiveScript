...
exports.For = For = (function(superclass){
  ...
  For.prototype.addBody = function(body){
    var hasYield, ref$, x$, that, itemName, this$ = this;
    ...
    if (this.guard && this['let'] && (this.index || this.item)) {
      itemName = this.item instanceof Obj
        ? this.item.name
        : this.item.value;
      this.body.lines[0].traverseChildren(function(it){
        if (it instanceof Var) {
          if (this$.index && it.value === this$.index) {
            it.value = 'index$$';
          }
          if (this$.item && it.value === itemName) {
            it.value = 'item$$';
          }
        }
      });
