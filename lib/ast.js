...
exports.Import = Import = (function(_super){
  ...
  prototype.unfoldSoak = function(o){
    ...
    if (left instanceof Existence && !left.negated) {
      _ref = left.it.cache(o, true), left.it = _ref[0], this.left = _ref[1], temps = _ref[2];
      return _ref = If(left, this), _ref.temps = temps, _ref.cond = this.cond, _ref['void'] = this['void'], _ref;
    }
