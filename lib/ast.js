...
(Node = function(){
  ...
  traverseChildren: function(fn, xscope){
    ...
    return this.eachChild(function(node, name, index){
      var __ref;
      return (__ref = fn(node, _this, name, index)) != null
        ? __ref
...
exports.fromJSON = (function(){
  function fromJSON(it){
    var that, node, key, val, v, __i, __len, _results = [];
...
exports.Block = Block = (function(superclass){
  ...
  function Block(node){
    var _this = this instanceof _ctor ? this : new _ctor;
  ...
  prototype.compileRoot = function(options){
    ...
    if ((__ref = o.repl, delete o.repl, __ref) && this.chomp().lines.length) {
      if (bare) {
  ...
  prototype.compileWithDeclarations = function(o){
    var pre, i, node, rest, post, that, __ref, __len;
    o.level = LEVEL_TOP;
    pre = '';
    for (i = 0, __len = (__ref = this.lines).length; i < __len; ++i) {
      node = __ref[i];
...
exports.Index = Index = (function(superclass){
  ...
  function Index(key, symbol, init){
    var k, _this = this instanceof _ctor ? this : new _ctor;
    symbol || (symbol = '.');
...
exports.Call = Call = (function(superclass){
  ...
  function _ctor(){} _ctor.prototype = prototype;
  function Call(args){
    var splat, _this = this instanceof _ctor ? this : new _ctor;
    args || (args = []);
  ...
  Call['let'] = function(name, args, body){
    var i, a, params, __res, __len, __ref;
    __res = [];
    ...
    return this.block((__ref = Fun(params, body), __ref.name = name, __ref['let'] = true, __ref), args, '.call');
  };
  return Call;
}(Node));
...
exports.Unary = Unary = (function(superclass){
  ...
  function Unary(op, it, flag){
    var that, node, __i, __ref, __len, _this = this instanceof _ctor ? this : new _ctor;
  ...
  prototype.invert = function(){
    var __ref;
    if (this.op === '!' && ((__ref = this.it.op) === '!' || __ref === '<' || __ref === '>' || __ref === '<=' || __ref === '>=' || __ref === 'in' || __ref === 'instanceof')) {
      return this.it;
    }
...
exports.Assign = Assign = (function(superclass){
  ...
  prototype.rendArr = function(o, nodes, rite){
    var i, node, skip, len, val, ivar, start, inc, rcache, __len, __ref, _results = [];
    for (i = 0, __len = nodes.length; i < __len; ++i) {
      ...
      _results.push((__ref = __clone(this), __ref.left = node, __ref.right = val, __ref['void'] = true, __ref).compile(o, LEVEL_PAREN));
    }
    return _results;
  };
  prototype.rendObj = function(o, nodes, rite){
    var node, splat, logic, key, rcache, val, __i, __len, __ref, _results = [];
...
exports.Import = Import = (function(superclass){
  ...
  prototype.unfoldSoak = function(o){
    var left, temps, __ref;
    left = this.left;
    if (left instanceof Existence && !left.negated) {
      __ref = left.it.cache(o), left.it = __ref[0], this.left = __ref[1], temps = __ref[2];
      if (temps) {
        left = left.it;
      }
  ...
  prototype.compileNode = function(o){
    ...
    for (i = 0, __len = items.length; i < __len; ++i) {
      ...
      if (test instanceof Splat) {
        code += (__ref = new Of(Var(ref), test.it), __ref.negated = this.negated, __ref).compile(o, LEVEL_TOP);
        if (!(i || sub === ref)) {
          code = "(" + sub + ", " + code + ")";
        }
      } else {
...
exports.For = For = (function(superclass){
  ...
  prototype.infuseIIFE = function(){
    ...
    this.body.traverseChildren(function(it){
      ...
      index = _this.index, item = _this.item;
