  ...
  List.prototype.toSlice = function(o, base, symbol, assign){
    ...
    for (i$ = 0, len$ = items.length; i$ < len$; ++i$) {
      ...
      if (!item.comment) {
        if (isObj) {
          val = item.val;
          if (!(val instanceof List || val instanceof Parens)) {
...
exports.Prop = Prop = (function(superclass){
  ...
  Prop.prototype.addLogic = function(op, value, assign){
    var binop;
    if (assign) {
      binop = CopyL(op, Assign(this.val, value, op));
    } else {
      binop = CopyL(op, Binary(op, this.val, value));
      binop.getDefault() || this.carp("invalid property shorthand");
    }
    return CopyL(this, Prop(this.key, binop));
  };
  ...
  Prop.prototype.rewriteShorthand = function(o, assign){
    ...
    if (assign && this.key instanceof Splat) {
      this.key.it = this.val.extractKeyRef(o, true);
    } else {
...
exports.Assign = Assign = (function(superclass){
  ...
  Assign.prototype.rendObj = function(o, nodes, rite){
    var i$, len$, ref$, key, lval, logic, splat, val, rcache, results$ = [];
    for (i$ = 0, len$ = nodes.length; i$ < len$; ++i$) {
      ref$ = nodes[i$], key = ref$.key, lval = ref$.val, logic = ref$.logic;
      if (splat = key instanceof Splat) {
        key = key.it;
      }
      lval = lval.unparen();
      if (logic) {
      ...
      val = Chain(rcache || (rcache = Var(rite)), [Index(key)]);
      if (splat) {
        val = Import(Obj(), val);
      }
      results$.push((ref$ = clone$(this), ref$.left = lval, ref$.right = val, ref$['void'] = true, ref$).compile(o, LEVEL_PAREN));
    }
    return results$;
  };
...
exports.Parens = Parens = (function(superclass){
  ...
  Parens.prototype.extractKeyRef = function(o, assign){
    var ref$, ref, key, val;
