...
exports.Block = Block = (function(_super){
  ...
  var prototype = __extends(Block, _super).prototype, constructor = Block;
  ...
  prototype.toJSON = function(){
    delete this.back;
    return Block.superclass.prototype.toJSON.call(this);
  };
...
Atom = (function(_super){
  ...
  var prototype = __extends(Atom, _super).prototype, constructor = Atom;
...
exports.Literal = Literal = (function(_super){
  ...
  var prototype = __extends(Literal, _super).prototype, constructor = Literal;
  function _ctor(){} _ctor.prototype = prototype;
...
exports.Var = Var = (function(_super){
  Var.displayName = 'Var';
  var prototype = __extends(Var, _super).prototype, constructor = Var;
  function _ctor(){} _ctor.prototype = prototype;
  function Var(value){
    var _this = new _ctor;
    _this.value = value;
...
exports.Key = Key = (function(_super){
  Key.displayName = 'Key';
  var prototype = __extends(Key, _super).prototype, constructor = Key;
  function _ctor(){} _ctor.prototype = prototype;
...
exports.Index = Index = (function(_super){
  ...
  var prototype = __extends(Index, _super).prototype, constructor = Index;
  function _ctor(){} _ctor.prototype = prototype;
...
exports.Chain = Chain = (function(_super){
  ...
  var prototype = __extends(Chain, _super).prototype, constructor = Chain;
  function _ctor(){} _ctor.prototype = prototype;
  ...
  prototype.expandSlice = function(o, assign){
    ...
    while (tail = tails[++i]) {
      if ((_ref = tail.key) != null && _ref.items) {
        ...
        this.head = tailz.pop().key.toSlice(o, Chain(this.head, tailz).unwrap(), assign);
...
exports.Call = Call = (function(_super){
  ...
  var prototype = __extends(Call, _super).prototype, constructor = Call;
  function _ctor(){} _ctor.prototype = prototype;
  function Call(args){
    var _this = new _ctor;
    args || (args = []);
  ...
  Call.back = function(params, node, bound){
    ...
    return node.back = (args[idx] = Fun(params, null, bound)).body, node;
  };
...
List = (function(_super){
  ...
  var prototype = __extends(List, _super).prototype, constructor = List;
...
exports.Obj = Obj = (function(_super){
  Obj.displayName = 'Obj';
  var prototype = __extends(Obj, _super).prototype, constructor = Obj;
  function _ctor(){} _ctor.prototype = prototype;
  function Obj(items){
    var _this = new _ctor;
    _this.items = items || [];
...
exports.Prop = Prop = (function(_super){
  ...
  var prototype = __extends(Prop, _super).prototype, constructor = Prop;
  function _ctor(){} _ctor.prototype = prototype;
...
exports.Arr = Arr = (function(_super){
  Arr.displayName = 'Arr';
  var prototype = __extends(Arr, _super).prototype, constructor = Arr;
  function _ctor(){} _ctor.prototype = prototype;
  function Arr(items){
    var _this = new _ctor;
    _this.items = items || [];
...
exports.Op = Op = (function(_super){
  Op.displayName = 'Op';
  var EQUALITY, COMPARER, prototype = __extends(Op, _super).prototype, constructor = Op;
  function _ctor(){} _ctor.prototype = prototype;
  function Op(op, first, second, post){
    var that, node, _i, _ref, _len, _this = new _ctor;
    if (that = !second && first.unaries) {
      that.push(op);
      return first;
    }
    switch (op) {
  ...
  prototype.isArray = function(){
    ...
    if (!this.second) {
      return this.first instanceof Arr && this.first.items.length || this.first instanceof Chain && this.first.isArray();
    }
  };
  prototype.isString = function(){
    var _ref;
  ...
  prototype.compileExistence = function(o, inv){
    ...
    if (this['void'] || !o.level) {
      _ = Existence(this.first, !inv);
      _ = Op('&&', _, this.second);
      return (_['void'] = true, _).compileNode(o);
    }
    _ = this.first.cache(o, true);
    return If(Existence(_[0], inv), _[1]).addElse(this.second).compileExpression(o);
  };
  function crement(it){
    return {
      '++': 'in',
  ...
  prototype.compileUnary = function(o){
    var that, op, it, code, _, _ref;
    if (that = this.compileSpread(o)) {
      return that;
    }
    op = this.op, it = this.first;
    switch (op) {
    case '!':
      it.cond = true;
      break;
    case 'new':
      ...
      break;
    case 'do':
      _ = it instanceof Existence && !it.negated
        ? Chain(it).add(Call())
        : Call.make(it);
      return (_ref = Parens(_), _ref.front = this.front, _ref.newed = this.newed, _ref).compile(o);
    case 'delete':
    ...
    if (this.post) {
      ...
      if ((op === 'new' || op === 'typeof' || op === 'delete') || (op === '+' || op === '-') && it.op === op) {
        op += ' ';
      }
      code = op + code;
    }
  ...
  prototype.compileSpread = function(o){
    ...
    it = this.first;
    ops = [this];
    for (; it instanceof Op && !it.second; it = it.first) {
      ops.push(it);
    }
    ...
    for (i = 0, _len = them.length; i < _len; ++i) {
      ...
      for (_i = ops.length - 1; _i >= 0; --_i) {
        op = ops[_i];
        node = Op(op.op, node, null, op.post);
      }
  ...
  prototype.compileAnyInstanceOf = function(o, items){
    ...
    test = Op('instanceof', sub, items.shift());
    for (_i = 0, _len = items.length; _i < _len; ++_i) {
      item = items[_i];
      test = Op('||', test, Op('instanceof', ref, item));
    }
  ...
  prototype.compileMinMax = function(o){
    ...
    _ = Op(this.op.charAt(), lefts[0], rites[0]);
    return If(_, lefts[1]).addElse(Block(rites[1])).compile(o);
  };
...
exports.Assign = Assign = (function(_super){
  ...
  var prototype = __extends(Assign, _super).prototype, constructor = Assign;
  function _ctor(){} _ctor.prototype = prototype;
...
exports.Import = Import = (function(_super){
  ...
  var prototype = __extends(Import, _super).prototype, constructor = Import;
  function _ctor(){} _ctor.prototype = prototype;
...
exports.Of = Of = (function(_super){
  Of.displayName = 'Of';
  var prototype = __extends(Of, _super).prototype, constructor = Of;
  ...
  prototype.compileNode = function(o){
    var level, sub, ref, arr, items, code, cmp, cnj, i, item, _ref, _len;
    _ref = this.item.cache(o, false, level = LEVEL_LIST), sub = _ref[0], ref = _ref[1];
    if (items = (arr = this.array.expandSlice(o).unwrap()).selections()) {
      code = '';
      level = LEVEL_OP + PREC['=='];
      _ref = this.negated
        ? [' !== ', ' && ']
      ...
      code = utility('indexOf') + ".call(" + arr.compile(o, level) + ", " + ref + ") " + (this.negated ? '<' : '>=') + " 0";
      if (sub === ref) {
        level = LEVEL_OP + PREC['<'];
      } else {
        code = sub + ", " + code;
...
exports.Existence = Existence = (function(_super){
  ...
  var prototype = __extends(Existence, _super).prototype, constructor = Existence;
  function _ctor(){} _ctor.prototype = prototype;
...
exports.Fun = Fun = (function(_super){
  Fun.displayName = 'Fun';
  var prototype = __extends(Fun, _super).prototype, constructor = Fun;
  function _ctor(){} _ctor.prototype = prototype;
  ...
  prototype.ripName = function(it){
    ...
    if ((_ref = it.tails) != null && _ref.length) {
...
exports.Class = Class = (function(_super){
  ...
  var prototype = __extends(Class, _super).prototype, constructor = Class;
  ...
  prototype.compile = function(o, level){
    ...
    if (that = this.sup) {
      args = [that];
      fun.proto = Util.Extends(vname, (_ref = fun.params)[_ref.length] = Var('_super'));
    }
...
exports.Super = Super = (function(_super){
  ...
  var prototype = __extends(Super, _super).prototype, constructor = Super;
  prototype.isAssignable = prototype.isCallable = YES;
  prototype.compile = function(o){
    var fun, key, _ref;
...
exports.Parens = Parens = (function(_super){
  ...
  var prototype = __extends(Parens, _super).prototype, constructor = Parens;
  function _ctor(){} _ctor.prototype = prototype;
...
exports.Splat = Splat = (function(_super){
  ...
  var _ref, prototype = __extends(Splat, _super).prototype, constructor = Splat;
  function _ctor(){} _ctor.prototype = prototype;
...
exports.Jump = Jump = (function(_super){
  ...
  var prototype = __extends(Jump, _super).prototype, constructor = Jump;
  ...
  prototype.getJump = function(ctx){
    ...
    if (that = this.label) {
      return __indexOf.call(ctx.labels || [], that) < 0 && this;
    }
  };
  prototype.compileNode = function(o){
    var that;
    if (that = this.label) {
      __indexOf.call(o.labels || [], that) >= 0 || this.carp("undefined label \"" + that + "\"");
    } else {
...
exports.Throw = Throw = (function(_super){
  ...
  var prototype = __extends(Throw, _super).prototype, constructor = Throw;
  function _ctor(){} _ctor.prototype = prototype;
  function Throw(it){
    var _this = new _ctor;
    _this.it = it;
...
exports.Return = Return = (function(_super){
  ...
  var prototype = __extends(Return, _super).prototype, constructor = Return;
  function _ctor(){} _ctor.prototype = prototype;
  function Return(it){
    var _this = new _ctor;
    if (it && it.value !== 'void') {
...
exports.While = While = (function(_super){
  ...
  var prototype = __extends(While, _super).prototype, constructor = While;
...
exports.For = For = (function(_super){
  For.displayName = 'For';
  var prototype = __extends(For, _super).prototype, constructor = For;
  function For(it){
    __importAll(this, it);
  }
  ...
  prototype.infuseIIFE = function(o){
    var _this = this;
    return this.body.traverseChildren(function(it){
      var fun, call, name, _ref;
      if (!(it.calling || it.op === 'new' && (fun = it.first).params)) {
        return;
      }
      if (fun) {
        call = (it.first = Call.make((fun['void'] = true, fun))).tails[0];
      } else {
...
exports.Try = Try = (function(_super){
  Try.displayName = 'Try';
  var prototype = __extends(Try, _super).prototype, constructor = Try;
...
exports.Switch = Switch = (function(_super){
  ...
  var prototype = __extends(Switch, _super).prototype, constructor = Switch;
...
exports.Case = Case = (function(_super){
  ...
  var prototype = __extends(Case, _super).prototype, constructor = Case;
...
exports.If = If = (function(_super){
  If.displayName = 'If';
  var prototype = __extends(If, _super).prototype, constructor = If;
  function _ctor(){} _ctor.prototype = prototype;
  ...
  prototype.compileExpression = function(o){
    ...
    pad = (_ref = this['else']) != null && _ref.isComplex() ? '\n' + (o.indent += TAB) : ' ';
...
exports.Label = Label = (function(_super){
  ...
  var _ref, prototype = __extends(Label, _super).prototype, constructor = Label;
  ...
  prototype.compileNode = function(o){
    ...
    if (__indexOf.call(labels, label) >= 0) {
...
exports.JS = JS = (function(_super){
  JS.displayName = 'JS';
  var prototype = __extends(JS, _super).prototype, constructor = JS;
  function _ctor(){} _ctor.prototype = prototype;
...
exports.Util = Util = (function(_super){
  ...
  var prototype = __extends(Util, _super).prototype, constructor = Util;
  function _ctor(){} _ctor.prototype = prototype;
  function Util(verb){
    var _this = new _ctor;
    _this.verb = verb;
