...
exports.Fun = Fun = (function(superclass){
  ...
  prototype.compileParams = function(scope){
    var params, body, names, assigns, i, len$, p, splace, rest, that, dic, i$, vr, df, v, ref$, ref1$, name;
...
exports.Class = Class = (function(superclass){
  ...
  prototype.compile = function(o, level){
    var fun, body, lines, title, boundFuncs, decl, name, proto, ctorName, ctor, ctorPlace, importProtoObj, i, len$, node, ref$, i$, f, vname, args, that, imports, res$, clas;
    ...
    function fn$(it){
      ...
      if (it instanceof Block) {
        for (k = 0, len$ = (ref$ = it.lines).length; k < len$; ++k) {
          child = ref$[k];
...
exports.Switch = Switch = (function(superclass){
  ...
  prototype.compileNode = function(o){
    var tab, ref$, targetNode, target, topic, t, code, stop, i, len$, c, that;
    tab = this.tab;
    if (this.target) {
...
exports.Require = Require = (function(superclass){
  ...
  prototype.compile = function(o){
    var stripString, getFileName, out, res$, i$, ref$, len$, item, chain, ref1$, asg, value, main;
