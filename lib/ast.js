...
exports.Binary = Binary = (function(superclass){
  ...
  prototype.compilePartial = function(o){
    ...
    case !(this.first == null && this.second == null):
      y = Chain(Var('__y'));
      return util('curry') + "(function(__x, __y){ return " + Binary(this.op, x, y).invertCheck(this).compile(o) + "; })";
    case this.first == null:
      return "(function(__x){ return " + Binary(this.op, this.first, x).invertCheck(this).compile(o) + "; })";
    default:
      return "(function(__x){ return " + Binary(this.op, x, this.second).invertCheck(this).compile(o) + ";})";
    }
  };
  return Binary;
}(Node));
