...
exports.Slice = Slice = (function(superclass){
  ...
  prototype.expandStar = function(o){
    var stars, i$, ref$, len$, boundary, sub, ref, temps, value, x$;
    stars = [];
    for (i$ = 0, len$ = (ref$ = [this.from, this.to]).length; i$ < len$; ++i$) {
      boundary = ref$[i$];
      if (boundary == null) {
        continue;
      }
    ...
    this.target = JS(sub.compile(o, LEVEL_CALL));
    if (temps) {
    ...
    function seek(it){
      if (it.value === '*') {
        stars.push(it);
      } else if (!(it instanceof Index || it instanceof Slice || it instanceof StepSlice)) {
        it.eachChild(seek);
      }
    }
  };
...
exports.Chain = Chain = (function(superclass){
  ...
  prototype.expandStar = function(o){
    var tails, i, that, stars, ref$, sub, ref, temps, value, i$, x$, len$;
    tails = this.tails;
    i = -1;
    while (that = tails[++i]) {
...
exports.StepSlice = StepSlice = (function(superclass){
  ...
  prototype.compileNode = function(o){
    ...
    return code += superclass.prototype.compileNode.apply(this, arguments);
  };
  prototype.expandStar = function(o, ref){
    var stars, i$, ref$, len$, boundary, value, x$;
    stars = [];
    for (i$ = 0, len$ = (ref$ = [this.from, this.to, this.step]).length; i$ < len$; ++i$) {
      boundary = ref$[i$];
      if (boundary.value === '*') {
        stars.push(boundary);
      } else {
