...
exports.Binary = Binary = (function(superclass){
  ...
  prototype.compileNode = function(o){
    var top, rite, items, displayOp, level, code;
    switch (this.op) {
    case '?':
    case '!?':
    ...
    displayOp = this.op === 'of'
      ? 'in'
      : this.op;
    code = this.first.compile(o, level = LEVEL_OP + PREC[displayOp]) + " " + displayOp + " " + this.second.compile(o, level);
    if (o.level <= level) {
      return code;
    } else {
      return "(" + code + ")";
