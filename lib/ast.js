...
exports.Chain = Chain = (function(_super){
  ...
  prototype.add = function(it){
    var that;
    if (this.tails.push(it) === 1 && this.head instanceof Super && it instanceof Call && !it.method) {
      it.method = '.call';
...
exports.Call = Call = (function(_super){
  ...
  prototype.show = function(){
    return [this['new']] + [this.method] + [this.soak];
  };
  prototype.compile = function(o){
...
exports.Import = Import = (function(_super){
  ...
  prototype.unfoldSoak = function(o){
    return (this['void'] || !o.level) && If.unfoldSoak(o, this, 'right');
  };
  prototype.compileNode = function(o){
    var right;
    right = this.right;
