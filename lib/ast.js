...
exports.Op = Op = (function(_super){
  ...
  prototype.compileRepeat = function(o){
    var x, n, ref, q, items, refs, i, item, _ref, _len;
    x = this.first, n = this.second;
    if (!(n instanceof Literal && n.value < 0x100)) {
    ...
    if (x instanceof Literal) {
      ...
      if (n < 1) {
        return (_ref = __clone(Block.prototype), _ref.lines = x.items, _ref).add(JS('[]')).compile(o);
      }
      items = x.items;
      refs = [];
      for (i = 0, _len = items.length; i < _len; ++i) {
