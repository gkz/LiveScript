...
exports.Binary = Binary = (function(superclass){
  ...
  prototype.compilePartial = function(o){
    ...
    case this.first == null:
      return "(" + Fun([x], Block(Binary(this.op, this.first, x).invertCheck(this))).compile(o) + ")";
    default:
      return "(" + Fun([x], Block(Binary(this.op, x, this.second).invertCheck(this))).compile(o) + ")";
    }
  };
  return Binary;
}(Node));
exports.Assign = Assign = (function(superclass){
  ...
  prototype.compileNode = function(o){
    ...
    if (lvar) {
      del = right.op === 'delete';
      if (op === '=') {
        o.scope.declare(name, left, this['const'] || o['const']);
