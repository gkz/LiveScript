...
exports.Assign = Assign = (function(_super){
  ...
  prototype.compileNode = function(o){
    var right, left, head, tails, name, code, del, that, _ref;
    right = this.right;
    ...
    code = (name + " " + (this.op === ':=' ? '=' : this.op) + " ") + (right.assigned = true, right).compile(o, LEVEL_LIST);
  ...
  prototype.compileDestructuring = function(o, left){
    ...
    if ((len > 1 || o.level) && (!ID.test(rite) || left.assigns(rite))) {
