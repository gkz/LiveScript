...
exports.Call = Call = (function(superclass){
  ...
  Call.back = function(params, node, bound, curried, generator){
    var fun, ref$, args, index, i$, len$, a;
    fun = Fun(params, void 8, bound, curried, void 8, generator);
...
exports.ForOf = ForOf = (function(superclass){
  var prototype = extend$((import$(ForOf, superclass).displayName = 'ForOf', ForOf), superclass).prototype, constructor = ForOf;
  function ForOf(opts){
    var this$ = this instanceof ctor$ ? this : new ctor$;
    import$(this$, opts);
    return this$;
  } function ctor$(){} ctor$.prototype = prototype;
  prototype.children = ['item', 'source'];
  prototype.compileNode = function(o){
    var head, body, item, source;
    o.loop = true;
    o.indent += TAB;
    head = [];
    body = this.compileBody(o);
    item = this.item;
    source = this.source.compile(o);
    head.push('for (');
    head.push('let ');
    head.push(item);
    head.push(' of ');
