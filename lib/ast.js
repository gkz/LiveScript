...
exports.Block = Block = (function(_super){
  ...
  prototype.compileRoot = function(options){
    var o, bare, prefix, i, node, code, _ref;
    o = (__import({
      level: LEVEL_TOP,
    ...
    if (_ref = o.repl, delete o.repl, _ref) {
      if (bare) {
        if (node = (_ref = this.lines)[i = _ref.length - 1]) {
...
exports.Assign = Assign = (function(_super){
  ...
  prototype.compileMinMax = function(o, left, right){
    ...
    test = Op('<>'.charAt(this.op === '<?='), lefts[0], rites[0]);
    put = Assign(lefts[1], rites[1], ':=');
    if (this['void'] || !o.level) {
      return Op('&&', test, put).compileNode(o);
    }
    _ref = test.first.cache(o, true), test.first = _ref[0], left = _ref[1];
    return If(test, put).addElse(left).compileNode(o);
  };
...
exports.Fun = Fun = (function(_super){
  ...
  prototype.compileParams = function(scope){
    var params, body, names, assigns, i, p, splace, rest, that, dic, vr, df, v, name, _len, _i, _ref;
