...
exports.Block = Block = (function(_super){
  ...
  prototype.delegate(['isCallable', 'isArray', 'isString', 'isMatcher'], function(it){
    var that;
...
exports.Chain = Chain = (function(_super){
  ...
  prototype.isMatcher = function(){
    return this.isString() || this.head.value === 'RegExp' && !this.tails[1] && this.tails[0] instanceof Call;
  };
...
exports.Parens = Parens = (function(_super){
  ...
  prototype.delegate(['isComplex', 'isCallable', 'isArray'], function(it){
    return this.it[it]();
  });
  prototype.delegate(['isString', 'isMatcher'], function(it){
    return this.string || this.it[it]();
  });
  prototype.compile = function(o, level){
    var it;
    level == null && (level = o.level);
