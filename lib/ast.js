...
exports.For = For = (function(superclass){
  ...
  prototype.addBody = function(body){
    ...
    if (this['let']) {
      ...
      body = Block(Call['let']((x$ = [], (that = (ref$ = this.index, delete this.index, ref$)) && x$.push(Assign(Var(that), Literal('index'))), (that = (ref$ = this.item, delete this.item, ref$)) && x$.push(Assign(that, Literal('item'))), x$), body));
    }
