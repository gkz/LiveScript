...
exports.For = For = (function(superclass){
  ...
  prototype.addBody = function(body){
    ...
    if (this['let']) {
      ...
      body = Block(Call['let']((x$ = [], (that = this.index, delete this.index, that) && x$.push(Assign(Var(that), Literal('index'))), (that = this.item, delete this.item, that) && x$.push(Assign(that, Literal('item'))), x$), body));
    }
    return superclass.prototype.addBody.call(this, body);
  };
  prototype.compileNode = function(o){
