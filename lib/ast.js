...
exports.Prop = Prop = (function(_super){
  ...
  function Prop(key, val){
    ...
    if (val.op === '~' && val.first instanceof Fun) {
      (val = val.first).params[1] && _this.carp('excess accessor parameters');
...
exports.Op = Op = (function(_super){
  ...
  prototype.compileExistence = function(o, inv){
    var fs;
    if (!o.level) {
      return Op('&&', Existence(this.first, !inv), this.second).compileNode(o);
    }
...
exports.Assign = Assign = (function(_super){
  ...
  prototype.compileNode = function(o){
    ...
    code = lvar && !o.level && right instanceof While
...
exports.Fun = Fun = (function(_super){
  ...
  prototype.compileNode = function(o){
    var pscope, sscope, scope, body, name, tab, code, that, empty, _ref;
    pscope = o.scope;
  ...
  prototype.compileParams = function(scope){
    var params, body, names, assigns, i, p, splace, rest, dic, vr, df, v, name, _len, _i, _ref;
...
exports.While = While = (function(_super){
  ...
  function While(test, negated, mode){
    this.test = test;
  ...
  prototype.show = function(){
    return [this.negated ? '!' : void 8] + [this.post ? 'do' : void 8];
  };
  prototype.isStatement = YES;
  prototype.isArray = YES;
  ...
  prototype.compileNode = function(o){
    ...
    this.test && (this.negated
      ? this.test = this.test.invert()
      : this.anaphorize());
    if (this.post) {
      return 'do {' + this.compileBody((o.indent += TAB, o), this.test);
    }
    if (test = (_ref = this.test) != null ? _ref.compile(o, LEVEL_PAREN) : void 8) {
      head = (that = this.update)
        ? "for (; " + test + "; " + that.compile(o, LEVEL_PAREN)
        : "while (" + test;
    }
    return (head || 'for (;;') + ') {' + this.compileBody((o.indent += TAB, o));
  };
  prototype.compileBody = function(o, potest){
    var lines, ret, code, last, i, res, that, _ref;
