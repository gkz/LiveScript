(function(){
  ...
  exports.Rewriter.prototype.addImplicitParentheses = function(){
    ...
    return this.scanTokens(function(token, i, tokens){
      ...
      if (!(callObject || (prev != null ? prev.spaced : void 0) && (prev.call || (_ref2 = prev[0], __indexOf.call(IMPLICIT_FUNC, _ref2) >= 0)) && (__indexOf.call(IMPLICIT_CALL, tag) >= 0 || tag === 'PLUS_MINUS' && !(token.spaced || token.newLine)))) {
        return 1;
      }
