...
function able(tokens, i, call){
  ...
  return (tag === 'IDENTIFIER' || tag === 'THISPROP' || tag === 'SUPER' || tag === ']') || (call
...
ARG = ['(', '[', '{', '...', 'IDENTIFIER', 'THISPROP', 'STRNUM', 'LITERAL', 'RANGE', 'SUPER', 'PARAM(', 'FUNC_ARROW', 'FUNCTION', 'UNARY', 'CREMENT', 'IF', 'TRY', 'CLASS', 'SWITCH'];