var BALANCED_PAIRS, INVERSES, OPENERS, CLOSERS, left, rite, CHAIN, ARG, _i, _len, _ref, __indexOf = [].indexOf || function(x){
...
for (_i = 0, _len = BALANCED_PAIRS.length; _i < _len; ++_i) {
  ...
  OPENERS.push(INVERSES[rite] = left);
  CLOSERS.push(INVERSES[left] = rite);
}
