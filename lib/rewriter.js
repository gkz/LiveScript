(function(){
  var BALANCED_PAIRS, EXPRESSION_CLOSE, EXPRESSION_END, EXPRESSION_START, IMPLICIT_BLOCK, IMPLICIT_CALL, IMPLICIT_END, IMPLICIT_FUNC, IMPLICIT_UNSPACED_CALL, INVERSES, LINEBREAKS, SINGLE_CLOSERS, SINGLE_LINERS, left, rite, _i, _len, _ref, __indexOf = Array.prototype.indexOf || function(item){
  ...
  exports.Rewriter.prototype.addImplicitBraces = function(){
    ...
    condition = function(token, i){
      ...
      tag = token[0];
      return (tag === "TERMINATOR" || tag === "OUTDENT") && !((one != null ? one[0] : void 0) === '(' || ((_ref2 = two != null ? two[0] : void 0) === ":" || _ref2 === "...")) || tag === ',' && one && ((_ref3 = one[0]) !== "IDENTIFIER" && _ref3 !== "STRNUM" && _ref3 !== "THISPROP" && _ref3 !== "TERMINATOR" && _ref3 !== "OUTDENT" && _ref3 !== "(");
    };
    action = function(token, i){
  ...
  IMPLICIT_CALL = ["IDENTIFIER", "THISPROP", "STRNUM", "LITERAL", "THIS", "UNARY", "PARAM_START", "IF", "TRY", "SWITCH", "CLASS", "->", "=>", "[", "(", "{", "--", "++"];
