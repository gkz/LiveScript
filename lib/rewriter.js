(function(){
  ...
  addImplicitBraces = function(tokens){
    ...
    ok = function(token, i){
      ...
      tag = token[0];
      return tag === ',' && (one !== "IDENTIFIER" && one !== "STRNUM" && one !== "THISPROP" && one !== "TERMINATOR" && one !== "OUTDENT" && one !== "(") || (tag === "TERMINATOR" || tag === "OUTDENT") && ((_ref = (_ref2 = tokens[i + 2]) != null ? _ref2[0] : void 8) !== ":" && _ref !== "...");
    };
    stack = [];
    i = -1;
    while (token = tokens[++i]) {
