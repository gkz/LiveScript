(function(){
  ...
  exports.Rewriter.prototype.addImplicitBraces = function(){
    ...
    start = null;
    condition = function(token, i){
      var one, tag, two, _ref, _ref2;
      if ('HERECOMMENT' === this.tag(i + 1) || 'HERECOMMENT' === this.tag(i - 1)) {
        return false;
      }
      _ref = this.tokens, one = _ref[i + 1], two = _ref[i + 2];
      tag = token[0];
      return (tag === "TERMINATOR" || tag === "OUTDENT") && !((two != null ? two[0] : void 0) === ':' || (one != null ? one[0] : void 0) === '(') || tag === ',' && one && ((_ref2 = one[0]) !== "IDENTIFIER" && _ref2 !== "NUMBER" && _ref2 !== "STRING" && _ref2 !== "THISPROP" && _ref2 !== "TERMINATOR" && _ref2 !== "OUTDENT" && _ref2 !== "(");
    };
    action = function(token, i){
  ...
  IMPLICIT_CALL = ["IDENTIFIER", "THISPROP", "NUMBER", "STRING", "JS", "REGEX", "NEW", "PARAM_START", "CLASS", "IF", "UNLESS", "TRY", "SWITCH", "THIS", "BOOL", "UNARY", "->", "=>", "[", "(", "{", "--", "++"];
