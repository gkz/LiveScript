...
function addImplicitParentheses(tokens){
  ...
  function ok(token, i){
    ...
    case 'INDENT':
      ...
      return (_ref = pre[0]) !== '{' && _ref !== '[' && _ref !== ',' && _ref !== '->' && _ref !== ':' && _ref !== 'ELSE' && _ref !== 'ASSIGN' && _ref !== 'IMPORT' && _ref !== 'UNARY' && _ref !== 'DEFAULT' && _ref !== 'TRY' && _ref !== 'CATCH' && _ref !== 'FINALLY';
    case 'TERMINATOR':
    case 'POST_IF':
    case 'FOR':
    case 'WHILE':
...
ARG = ['IDENTIFIER', 'STRNUM', 'LITERAL', '(', '[', '{', '->', 'PARAM(', 'FUNCTION', '...', 'UNARY', 'CREMENT', 'IF', 'TRY', 'CLASS', 'SWITCH', 'LET', 'WITH', 'RANGE', 'SUPER', 'LABEL'];