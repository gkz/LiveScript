(function(){
  ...
  addImplicitParentheses = function(tokens){
    ...
    while (token = tokens[++i]) {
      ...
      if (!(prev.call || ((_ref = prev[0]) === 'IDENTIFIER' || _ref === 'THISPROP' || _ref === 'SUPER' || _ref === 'THIS' || _ref === ')' || _ref === 'CALL_END' || _ref === ']' || _ref === 'INDEX_END') || prev[0] === 'STRNUM' && ((_ref = tokens[i - 2]) != null ? _ref[0] : void 8) === 'ACCESS')) {
        continue;
      }
