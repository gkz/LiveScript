(function(){
  ...
  exports.Lexer = (function(){
    ...
    Lexer.prototype.heregexToken = function(match){
      var body, flags, heregex, tag, tokens, value, _i, _len, _ref, _ref2;
      ...
      (_ref2 = this.tokens).push.apply(_ref2, tokens);
      if (flags) {
    ...
    Lexer.prototype.literalToken = function(){
      var id, prev, pval, tag, value, _ref, _ref2, _ref3, _ref4, _ref5;
      ...
      case ';':
        ...
        break;
      case '?':
        if ((_ref2 = this.tokens)[_ref2.length - 1].spaced) {
          tag = 'LOGIC';
        }
        break;
      case '\\\n':
      ...
      default:
        ...
        if (!(prev = (_ref3 = this.tokens)[_ref3.length - 1]).spaced) {
