var rewrite, able, string, untabify, JS_KEYWORDS, COCO_KEYWORDS, COCO_ALIASES, RESERVED, FORBIDDEN, IDENTIFIER, NUMBER, SYMBOL, SPACE, MULTIDENT, SIMPLESTR, JSTOKEN, REGEX, HEREGEX, HEREGEX_OMIT, MULTILINER, LINE_CONTINUER, _ref, __clone = function(it){
...
exports.singleStringToken = function(it){
  ...
  this.strnum((str = str[0]).replace(MULTILINER, '\\\n'));
...
exports.doubleStringToken = function(it){
  ...
  if (0 < str.indexOf('#{', 1)) {
    ...
    this.strnum(str.replace(MULTILINER, ''));
  }
  return this.countLines(str).length;
};
