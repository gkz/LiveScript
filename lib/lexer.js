(function(){
  var CALLABLE, COCO_ALIASES, COCO_KEYWORDS, COMMENTS, HEREDOC_INDENT, HEREGEX, HEREGEX_OMIT, IDENTIFIER, INDEXABLE, JSTOKEN, JS_FORBIDDEN, JS_KEYWORDS, LINE_CONTINUER, Lexer, MULTIDENT, MULTILINER, NUMBER, REGEX, RESERVED, SIMPLESTR, SYMBOL, TRAILING_SPACES, WHITESPACE, __indexOf = Array.prototype.indexOf || function(x){
  ...
  exports.Lexer = Lexer = (function(){
    ...
    _ref.heredocToken = function(q){
      ...
      text = this.chunk.slice(3, end);
      doc = this.sanitizeHeredoc(text.replace(/\n[^\n\S]*$/, ''), {
        q: q
      });
      if (q === '"' && ~doc.indexOf('#{')) {
