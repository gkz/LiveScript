(function(){
  var CALLABLE, COCO_ALIASES, COCO_KEYWORDS, HEREGEX, HEREGEX_OMIT, IDENTIFIER, INDEXABLE, JSTOKEN, JS_FORBIDDEN, JS_KEYWORDS, LINE_CONTINUER, Lexer, MULTIDENT, MULTILINER, NUMBER, REGEX, RESERVED, SIMPLESTR, SPACE, SYMBOL, __indexOf = Array.prototype.indexOf || function(x){
  ...
  exports.Lexer = Lexer = (function(){
    ...
    _ref.heredocToken = function(q){
      var dent, doc, end, len, lnl, m, tabs, txt;
    ...
    _ref.heregexToken = function(){
      var body, bs, flags, heregex, i, match, token, tokens, val, _len, _ref;
    ...
    _ref.wordsToken = function(){
      var call, end, line, re, word, words, _i, _j, _len, _len2, _ref;
    ...
    _ref.interpolateString = function(str, newline){
      var chr, code, i, line, nested, pi, s, t, tokens, ts, _len, _ref;
      line = this.line;
      ts = [];
      pi = 0;
      i = -1;
