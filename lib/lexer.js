(function(){
  var CALLABLE, COCO_ALIASES, COCO_KEYWORDS, HEREGEX, HEREGEX_OMIT, IDENTIFIER, INDEXABLE, JSTOKEN, JS_FORBIDDEN, JS_KEYWORDS, LINE_CONTINUER, Lexer, MULTIDENT, MULTILINER, NUMBER, REGEX, RESERVED, SIMPLESTR, SYMBOL, WHITESPACE, __indexOf = Array.prototype.indexOf || function(x){
    ...
    _ref.tokenize = function(code, o){
      ...
      while (this.chunk = code.slice(i)) {
        ...
        case '/':
          ...
          break;
        case '#':
          i += this.whitespaceToken() || this.commentToken();
          break;
        case '`':
          i += this.jsToken();
          break;
