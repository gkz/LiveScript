(function(){
  ...
  exports.lineToken = function(){
    ...
    noNewline = LINE_CONTINUER.test(this.chunk) || ((_ref = this.last[0]) === '+-' || _ref === 'DOT' || _ref === 'INDEX[' || _ref === 'ASSIGN' || _ref === 'LOGIC' || _ref === 'MATH' || _ref === 'COMPARE' || _ref === 'RELATION' || _ref === 'SHIFT' || _ref === 'IMPORT');
