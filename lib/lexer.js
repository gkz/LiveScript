(function(){
  ...
  exports.Lexer = Lexer = (function(){
    function Lexer(){}
    Lexer.name = "Lexer";
    __importAll(Lexer.prototype, {
      tokenize: function(_arg, o){
      ...
      heregexToken: function(){
        var body, flags, heregex, match, tag, tokens, value, _i, _len, _ref;
      ...
      outdentToken: function(moveOut, noNewlines){
        var dent, idt, len;
        while (moveOut > 0) {
      ...
      balancedString: function(str, delimited, options){
      ...
      interpolateString: function(str, _arg){
