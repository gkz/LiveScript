(function(){
  ...
  exports.Lexer = (function(){
    ...
    Lexer.prototype.identifierToken = function(){
      ...
      forcedIdentifier = at || colon || ((prev = last(this.tokens))[1].colon2 ? this.token('ACCESS', '.') : prev[0] === 'ACCESS');
    ...
    Lexer.prototype.literalToken = function(){
      var id, prev, pval, tag, value, _ref, _ref2;
      value = SYMBOL.exec(this.chunk)[0];
      switch (tag = value) {
      case "=":
      case ":=":
        pval = (prev = last(this.tokens))[1];
      ...
      default:
        ...
        if (!(prev = last(this.tokens)).spaced) {
