(function(){
  ...
  exports.Lexer = function(){
    ...
    Lexer.prototype.identifierToken = function(){
      ...
      if (id === 'all' && ((_ref2 = this.tag()) === 'FOR' || _ref2 === 'IMPORT')) {
        this.token('ALL', id);
        return id.length;
      }
      ...
      forcedIdentifier = colon || ((prev = last(this.tokens)) ? prev[1].colon2 ? this.token('ACCESS', '.') : prev[0] === 'ACCESS' || !prev.spaced && prev[0] === '@' : void 0);
      tag = 'IDENTIFIER';
      ...
      if (!id.reserved && __indexOf.call(JS_KEYWORDS, id) >= 0 || !forcedIdentifier && __indexOf.call(COFFEE_KEYWORDS, id) >= 0) {
        tag = id.toUpperCase();
        if (tag === 'WHEN' && ((_ref3 = this.tag()) === "INDENT" || _ref3 === "OUTDENT" || _ref3 === "TERMINATOR")) {
          tag = 'LEADING_WHEN';
        } else if (tag === 'FOR') {
          this.seenFor = true;
      ...
      if (!forcedIdentifier) {
        ...
        tag = id === '!' ? 'UNARY' : id === "==" || id === "!=" ? 'COMPARE' : id === "&&" || id === "||" ? 'LOGIC' : id === "true" || id === "false" || id === "null" || id === "void" ? 'BOOL' : tag;
      }
      this.token(tag, id);
      if (colon) {
        this.token(':', ':');
    ...
    Lexer.prototype.regexToken = function(){
      ...
      if ((_ref2 = this.tag()) === "NUMBER" || _ref2 === "REGEX" || _ref2 === "BOOL" || _ref2 === "++" || _ref2 === "--") {
        return 0;
      }
    ...
    Lexer.prototype.wordsToken = function(){
      var match, word, words, _i, _len, _ref2;
    ...
    Lexer.prototype.literalToken = function(){
      var id, match, pid, prev, tag, value, _ref2, _ref3;
      ...
      if (value === "!" || value === "~") {
        ...
        id.colon2 = true;
        this.tokens.push(['ACCESS', '.', this.line], ['IDENTIFIER', id, this.line]);
        return value.length;
      } else if (prev && !prev.spaced) {
        if (value === '(' && (_ref2 = prev[0], __indexOf.call(CALLABLE, _ref2) >= 0)) {
          if (prev[0] === '?') {
            prev[0] = 'FUNC_EXIST';
          }
          tag = 'CALL_START';
  ...
  JS_KEYWORDS = ["true", "false", "null", "this", "void", "new", "do", "delete", "typeof", "in", "instanceof", "import", "return", "throw", "break", "continue", "debugger", "if", "else", "switch", "for", "while", "try", "catch", "finally", "class", "extends", "super"];
