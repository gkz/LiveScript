(function(){
  ...
  exports.Lexer = function(){
    ...
    Lexer.prototype.identifierToken = function(){
      ...
      forcedIdentifier = colon || (prev = last(this.tokens)) && !prev.spaced && ((_ref3 = prev[0]) === '.' || _ref3 === '?.' || _ref3 === '@' || _ref3 === '::');
      tag = 'IDENTIFIER';
      ...
      if (!id.reserved && __indexOf.call(JS_KEYWORDS, id) >= 0 || !forcedIdentifier && __indexOf.call(COFFEE_KEYWORDS, id) >= 0) {
        tag = id.toUpperCase();
        if (tag === 'WHEN' && ((_ref4 = this.tag()) === "INDENT" || _ref4 === "OUTDENT" || _ref4 === "TERMINATOR")) {
          tag = 'LEADING_WHEN';
        } else if (tag === 'FOR') {
          this.seenFor = true;
    ...
    Lexer.prototype.literalToken = function(){
      var match, pid, prev, tag, value, _ref2, _ref3;
