(function(){
  ...
  exports.Lexer = function(){
    ...
    Lexer.prototype.identifierToken = function(){
      var at, colon, forcedIdentifier, id, input, match, prev, tag, _ref2;
    ...
    Lexer.prototype.heregexToken = function(match){
      var body, flags, heregex, tag, tokens, value, _i, _len, _ref2, _ref3, _this;
    ...
    Lexer.prototype.literalToken = function(){
      ...
      if (value === "!" || value === "~") {
        ...
        this.tokens.push(['IDENTIFIER', 'arguments', this.line], ["INDEX_START", "["], ['NUMBER', value.slice(1)], ["INDEX_END", "]"]);
        return value.length;
      } else if (value === '::') {
