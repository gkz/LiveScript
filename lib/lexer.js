(function(){
  var CALLABLE, COCO_ALIASES, COCO_KEYWORDS, COMMENTS, HEREDOC_INDENT, HEREDOUBLE, HEREGEX, HEREGEX_OMIT, HERESINGLE, IDENTIFIER, INDEXABLE, JSTOKEN, JS_FORBIDDEN, JS_KEYWORDS, LINE_CONTINUER, Lexer, MULTIDENT, MULTILINER, NUMBER, REGEX, RESERVED, SIMPLESTR, SYMBOL, TRAILING_SPACES, WHITESPACE, __indexOf = Array.prototype.indexOf || function(x){
  ...
  exports.Lexer = Lexer = (function(){
    ...
    _ref.commentToken = function(){
      ...
      this.token('HERECOMMENT', this.sanitizeHeredoc(text, {
        comment: true,
