(function(){
  ...
  exports.Lexer = Lexer = (function(){
    ...
    _ref = Lexer.prototype, _ref.tokenize = function(_arg, o){
      ...
      case "=":
      case ":=":
        if (value === '=' && ((_ref = (prev = this.last)[1]) === "||" || _ref === "&&")) {
      ...
      var _ref;
      return LINE_CONTINUER.test(this.chunk) || ((_ref = this.last[0]) === "ACCESS" || _ref === "INDEX_START" || _ref === "PLUS_MINUS" || _ref === "MATH" || _ref === "COMPARE" || _ref === "LOGIC" || _ref === "RELATION" || _ref === "IMPORT" || _ref === "SHIFT");
