  ...
  default:
    ...
    case 'til':
      ...
      if (this.fget('from')) {
        ...
        this.fset('by', true);
        tag = 'TO';
      } else if (!last.callable && last[0] === 'STRNUM' && last[1] !== '*' && (ref$ = this.tokens)[ref$.length - 2][0] === '[') {
        last[0] = 'RANGE';
        last.op = id;
        return id.length;
      ...
      break;
    case 'by':
      if (last[0] === 'STRNUM' && last[1] !== '*' && (ref$ = this.tokens)[ref$.length - 2][0] === 'RANGE' && (ref$ = this.tokens)[ref$.length - 3][0] === '[') {
        tag = 'RANGE_BY';
      } else if (in$(']', this.closes)) {
        tag = 'BY';
...
function expandLiterals(tokens){
  ...
  while (token = tokens[++i]) {
    ...
    case 'TO':
    case 'TIL':
      if (!(tokens[i - 1][0] === '[' && ((tokens[i + 2][0] === ']' && (((ref$ = tokens[i + 1][1].charAt(0)) === '\'' || ref$ === '"') || +tokens[i + 1][1] >= 0)) || (tokens[i + 2][0] === 'BY' && ((ref$ = tokens[i + 1]) != null ? ref$[0] : void 8) === 'STRNUM' && ((ref$ = tokens[i + 1]) != null ? ref$[1] : void 8) !== '*' && ((ref$ = tokens[i + 3]) != null ? ref$[0] : void 8) === 'STRNUM' && ((ref$ = tokens[i + 3]) != null ? ref$[1] : void 8) !== '*' && ((ref$ = tokens[i + 4]) != null ? ref$[0] : void 8) === ']')))) {
        continue;
      }
      if (tokens[i + 2][0] === 'BY') {
