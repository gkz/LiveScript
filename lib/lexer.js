(function(){
  var string, dedent, JS_KEYWORDS, COCO_KEYWORDS, COCO_ALIASES, RESERVED, JS_FORBIDDEN, IDENTIFIER, NUMBER, SYMBOL, SPACE, MULTIDENT, SIMPLESTR, JSTOKEN, REGEX, HEREGEX, HEREGEX_OMIT, MULTILINER, LINE_CONTINUER, CALLABLE, INDEXABLE, _ref, __indexOf = Array.prototype.indexOf || function(x){
    ...
    if (forcedIdentifier) {
      ...
      case 'INSTANCEOF':
        if (tag !== 'INSTANCEOF' && this.seenFor) {
          if (tag === 'OF') {
            this.seenRange = true;
            id = this.last[0] === 'IDENTIFIER' && (_ref = this.tokens)[_ref.length - 2][0] === ',' && (this.tokens.splice(-2, 2), this.last[1]);
          }
          this.seenFor = false;
          tag = 'FOR' + tag;
          break;
  ...
  _ref.commentToken = function(){
    ...
    this.token('COMMENT', dedent(text, this.indent));
