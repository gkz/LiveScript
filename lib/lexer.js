var rewrite, able, string, untabify, unlines, enlines, JS_KEYWORDS, COCO_ALIASES, RESERVED, IDENTIFIER, NUMBER, SYMBOL, SPACE, MULTIDENT, SIMPLESTR, JSTOKEN, REGEX, HEREGEX, HEREGEX_OMIT, LINE_CONTINUER, _ref, __clone = function(it){
...
exports.identifierToken = function(it){
  ...
  } else if (__indexOf.call(JS_KEYWORDS, id) >= 0 || (id === 'then' || id === 'of' || id === 'unless' || id === 'until' || id === 'arguments' || id === 'eval')) {
...
RESERVED = ['var', 'with', 'const', 'enum', 'export'];
