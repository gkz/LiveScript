(function(){
  ...
  exports.Switch = (function(){
    ...
    Switch.prototype.compileNode = function(o){
      var addCase, block, body, c, code, cond, conditions, expr, i, idt, subject, tab, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3, _ref4;
      tab = this.tab, subject = this.subject;
      idt = o.indent = this.idt(1);
      code = tab + ("switch (" + (((_ref = this.subject) != null ? _ref.compile(o, LEVEL_PAREN) : void 0) || false) + ") {\n");
      addCase = function(cond){
        if (!subject) {
          cond = cond.invert();
        }
        return code += tab + ("case " + cond.compile(o, LEVEL_PAREN) + ":\n");
      };
      for (i = 0, _len = this.cases.length; i < _len; ++i) {
        _ref2 = this.cases[i], conditions = _ref2[0], block = _ref2[1];
        for (_i = 0, _len2 = conditions.length; _i < _len2; ++_i) {
          cond = conditions[_i];
          if ((cond = cond.unwrap()) instanceof Arr) {
            _ref3 = cond.objects;
