(function(){
  ...
  exports.Base = Base = (function(){
    ...
    _ref = Base.prototype, _ref.compile = function(options, level){
      ...
      return node;
    }, _ref.children = [], _ref.isStatement = NO, _ref.isPureStatement = NO, _ref.isComplex = YES, _ref.isChainable = NO, _ref.isAssignable = NO, _ref.isArray = NO, _ref.isObject = NO, _ref.assigns = NO, _ref.unwrap = THIS, _ref.unfoldSoak = NO, _ref.unfoldAssign = NO, _ref.toString = function(idt, override){
  ...
  exports.Value = Value = (function(){
    ...
    _ref = Value.prototype, _ref.children = ["base", "properties"], _ref.append = function(it){
      ...
      var asn, code, p, ps, v, _i, _len, _ref;
      if (asn = this.unfoldAssign(o)) {
        return asn.compile(o);
      }
      _ref = this.base, _ref.front = this.front;
  ...
  exports.Call = Call = (function(){
    ...
    _ref = Call.prototype, _ref.children = ["variable", "args"], _ref.newInstance = function(){
      ...
      var arg, args, asn, sup, _ref;
      if (!this["super"]) {
        if (asn = this.unfoldAssign(o)) {
          return asn.compile(o);
        }
        _ref = this.variable, _ref.front = this.front;
      }
  ...
  exports.Import = Import = (function(){
    ...
    _ref = Import.prototype, _ref.children = ["left", "right"], _ref.compileNode = function(o){
      var acc, code, com, key, lref, node, ref, sub, val, _i, _len, _ref, _ref2;
      ...
      this.temps = [];
      code = '';
      for (_i = 0, _len = (_ref = this.right.unwrap().properties).length; _i < _len; ++_i) {
        node = _ref[_i];
        code += com ? ' ' : ', ';
        ...
        if (node instanceof Assign) {
          val = node.value, (_ref2 = node.variable, acc = _ref2.base, _ref2);
          ...
          if (node["this"]) {
            ...
            _ref2 = (acc = node.unwrapAll()).cache(o, LEVEL_LIST, ref), key = _ref2[0], val = _ref2[1];
            if (key !== val) {
  ...
  exports.Assign = Assign = (function(){
    ...
    Assign.name = "Assign";
    _ref = Assign.prototype, _ref.children = ["variable", "value"], _ref.assigns = function(name){
      ...
      if (top && olen === 1 && !((obj = objects[0]) instanceof Splat)) {
        if (obj instanceof Assign) {
          _ref = obj, obj = _ref.value, (_ref2 = _ref.variable, idx = _ref2.base, _ref2);
        } else {
  ...
  exports.While = While = (function(){
    ...
    While.name = "While";
    _ref = While.prototype, _ref.children = ["condition", "guard", "body"], _ref.isStatement = YES, _ref.addBody = function(_arg){
      this.body = _arg;
      return this;
    }, _ref.makeReturn = function(){
      this.returns = true;
      return this;
    }, _ref.makePush = function(o, body){
      var exps, last, res;
  ...
  exports.Op = Op = (function(){
    ...
    _ref = Op.prototype, _ref.children = ["first", "second"], _ref.isChainable = function(){
      return this.operator in INVERSIONS;
    }, _ref.invert = function(){
      var op;
      ...
      _ref = this.first, _ref.front = this.front;
  ...
  exports.Parens = Parens = (function(){
    ...
    _ref = Parens.prototype, _ref.children = ['expression'], _ref.unwrap = function(){
      ...
      var code, expr, _ref;
      expr = (_ref = this.expression, _ref.front = this.front, _ref);
  ...
  exports.For = For = (function(){
    ...
    _ref = For.prototype, _ref.children = ["source", "name", "from", "to", "step", "guard", "body"], _ref.compileNode = function(o){
      var body, code, cond, eq, forPart, index, item, lvar, ownPart, pvar, ret, scope, srcPart, step, svar, tail, tvar, vars, _ref;
      ...
      code = this.pluckDirectCalls(o, body, this.name, index);
      o.indent += TAB;
      ...
      if (this.name) {
        ...
        code += Assign(this.name, Literal(item)).compile(o, LEVEL_TOP) + ';';
      }
      if (!body.isEmpty()) {
        if (this.returns) {
          ret = this.makePush(o, body);
      ...
      return code + '}' + (ret || '');
    }, _ref.pluckDirectCalls = function(o, body, name, index){
      var args, base, defs, exp, fn, idx, li, ref, val, _len, _ref, _ref2;
      defs = '';
  ...
  exports.Switch = Switch = (function(){
    ...
    _ref = Switch.prototype, _ref.children = ["switch", "cases", "default"], _ref.isStatement = YES, _ref.makeReturn = function(){
      ...
      var code, cs, exp, i, stop, tab, _i, _len, _ref, _ref2;
      tab = this.tab;
      o.indent += TAB;
      ...
      if (this["default"]) {
        code += tab + ("default:\n" + this["default"].compile(o, LEVEL_TOP) + "\n");
      }
      return code + tab + '}';
    };
    return Switch;
