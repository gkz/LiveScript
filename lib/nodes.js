(function(){
  ...
  exports.Op = Op = (function(){
    ...
    _ref.invert = function(){
      var fst, op, _ref;
      if (EQUALITY.test(op = this.op)) {
        this.op = {
          '=': '!',
          '!': '='
        }[op.charAt(0)] + op.slice(1);
        return this;
      } else if (this.second) {
        return Op('!', Parens(this));
      } else if (op === '!' && (fst = this.first.unwrap()) instanceof Op && ((_ref = fst.op) === "!" || _ref === "in" || _ref === "instanceof")) {
        return fst;
      } else {
        return Op('!', this);
      }
    ...
    _ref.compileNode = function(o){
      ...
      if (this.first instanceof Op && COMPARER.test(this.op) && COMPARER.test(this.first.op)) {
