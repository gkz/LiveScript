    ...
    __importAll(Code.prototype, {
      ...
      compileNode: function(o){
        ...
        if (this.ctor && this.bound) {
          ...
          Base.prototype.traverseChildren.call(this, false, function(it){
            ...
            case !(it instanceof Return):
              return it.expression || (it.expression = new Literal('_this'));
            }
          });
        ...
        for (_i = 0, _len = params.length; _i < _len; ++_i) {
          param = params[_i];
          if (param.splat) {
            splats = new Assign(new Arr((function(){
              var _i, _len, _ref, _results = [];
        ...
        for (_i = 0, _len = params.length; _i < _len; ++_i) {
          ...
          if (param.isComplex()) {
            ...
            ref = param;
            if (param.value) {
              exps.push(new Op('&&', new Literal(ref.name.value + ' == null'), new Assign(param.name, param.value)));
            }
          }
          if (!splats) {
            vars.push(ref);
