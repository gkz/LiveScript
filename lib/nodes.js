(function(){
  var Accessor, Arr, Assign, Base, Call, Case, Class, Closure, Code, Comment, Existence, Expressions, Extends, For, IDENTIFIER, If, Import, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NO, NUMBER, Obj, Op, Param, Parens, Push, Return, SIMPLENUM, Scope, Splat, Switch, TAB, THIS, TRAILING_WHITESPACE, Throw, Try, UTILITIES, Value, While, YES, del, last, multident, utility, _ref, __importAll = function(obj, src){
  ...
  _ref = require('./helpers'), del = _ref.del, last = _ref.last;
  ...
  exports.Call = (function(){
    ...
    Call.prototype.compileNode = function(o){
      var arg, args, asn, call, code, vr, _i, _len, _ref, _result;
      if (vr = this.variable) {
        _ref = this.digCalls();
        for (_i = 0, _len = _ref.length; _i < _len; ++_i) {
          call = _ref[_i];
  ...
  exports.Obj = (function(){
    ...
    Obj.prototype.compileNode = function(o){
      var code, i, idt, lastIndex, lastNonComment, prop, props, rest, _i, _len, _ref;
      ...
      for (i = 0, _len = props.length; i < _len; ++i) {
        ...
        code += prop instanceof Value && prop["this"] ? new Assign(prop.properties[0].name, prop, ':').compile(o) : !(prop instanceof Assign || prop instanceof Comment) ? new Assign(prop, prop, ':').compile(o) : prop.compile(o);
  ...
  exports.Assign = (function(){
    ...
    Assign.prototype.compileAccess = function(o){
      var acc, base, code, left, rite, val, _ref;
      if ((val = this.value) instanceof Call) {
        val = val.variable;
      }
  ...
  exports.Code = (function(){
    ...
    Code.prototype.compileNode = function(o){
      var close, code, comm, exprs, func, i, idt, lit, open, p, param, ref, scope, sharedScope, splats, v, val, vars, wasEmpty, _i, _j, _len, _len2, _ref, _ref2, _result;
      ...
      if (exprs.length) {
        (_ref = this.body.expressions).splice.apply(_ref, [0, 0].concat(__slice.call(exprs)));
      }
  ...
  exports.Splat = (function(){
    ...
    Splat.compileArray = function(o, list, apply){
      var args, base, code, i, index, node, _i, _len, _ref, _result;
      index = -1;
  ...
  exports.While = (function(){
    ...
    While.prototype.compileNode = function(o){
      ...
      if (body.isEmpty()) {
        ...
        if (this.guard) {
          body = new Expressions(new If(this.guard, body, {
            'statement': 'statement'
          }));
        }
  ...
  exports.Op = (function(){
    ...
    Op.prototype.compileMultiIO = function(o){
      var code, i, item, ref, sub, tests, _len, _ref, _result;
      _ref = this.first.cache(o, LEVEL_OP), sub = _ref[0], ref = _ref[1];
      tests = (function(){
        _ref = this.second.base.objects;
        _result = [];
        for (i = 0, _len = _ref.length; i < _len; ++i) {
          item = _ref[i];
  ...
  exports.In = (function(){
    ...
    In.prototype.compileOrTest = function(o){
      var cmp, cnj, code, i, item, ref, sub, tests, _len, _ref, _result;
  ...
  exports.Existence = (function(){
    ...
    Existence.prototype.compileNode = function(o){
      ...
      code = IDENTIFIER.test(code) && !o.scope.check(code, true) ? "typeof " + code + " != \"undefined\" && " + code + " !== null" : "" + code + " != null";
  ...
  exports.For = (function(){
    ...
    For.prototype.compileNode = function(o){
      var body, code, cond, defPart, eq, forPart, guardPart, idt, index, ivar, lvar, name, namePart, pvar, ref, refs, retPart, rvar, scope, sourcePart, step, svar, tail, tvar, varPart, vars, _i, _len, _ref, _ref2, _ref3;
      scope = o.scope;
      body = this.body;
      refs = [];
      ...
      if (!(ivar = index)) {
        refs.push(ivar = scope.freeVariable('i'));
      }
      if (this.step) {
      ...
      if (this.from) {
        eq = this.op === 'til' ? '' : '=';
        _ref3 = this.to.compileLoopReference(o, 'to'), tail = _ref3[0], tvar = _ref3[1];
        ...
        if (name || this.object && !this.raw) {
          _ref3 = this.source.compileLoopReference(o, 'ref'), sourcePart = _ref3[0], svar = _ref3[1];
          if (sourcePart !== svar) {
            refs.push(svar);
          }
        } else {
  ...
  exports.Switch = (function(){
    Switch = (function(){
      function Switch(_arg, _arg2, _arg3){
        var cs, test, _i, _j, _len, _len2, _ref, _ref2, _result;
        this.subject = _arg;
        this.cases = _arg2;
    ...
    Switch.prototype.compileNode = function(o){
      ...
      for (i = 0, _len = _ref.length; i < _len; ++i) {
        ...
        _ref2 = cs.body.expressions;
        for (_i = _ref2.length - 1; _i >= 0; --_i) {
          exp = _ref2[_i];
  ...
  exports.Case = (function(){
    ...
    Case.prototype.compile = function(o){
      var add, body, c, code, test, _i, _j, _len, _len2, _ref, _ref2;
      code = '';
      add = function(it){
        return code += o.tab + ("case " + it.compile(o, LEVEL_PAREN) + ":\n");
      };
      _ref = this.tests;
      for (_i = 0, _len = _ref.length; _i < _len; ++_i) {
        test = _ref[_i];
  ...
  exports.If = (function(){
    ...
    If.prototype.compileStatement = function(o){
      ...
      return ifPart + ' else ' + (this.isChain ? this.elseBodyNode().compile(__importAll(o, {
        indent: this.tab,
        chainChild: true
  ...
  Closure = {
    wrap: function(expressions, statement, noReturn){
      ...
      return statement ? new Expressions(call) : call;
    },
