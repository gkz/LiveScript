(function(){
  ...
  exports.Base = (function(){
    ...
    Base.prototype.compile = function(o, level){
      ...
      node.tab = o.indent;
      code = o.level === LEVEL_TOP || node.isPureStatement() || !node.isStatement(o) ? node.compileNode(o) : node.compileClosure(o);
      if (node.temps) {
        _ref = node.temps;
  ...
  exports.For = (function(){
    ...
    For.prototype.compileNode = function(o){
      var body, code, cond, defPart, eq, forPart, guardPart, idt, index, ivar, lvar, name, namePart, pvar, retPart, rvar, scope, sourcePart, step, svar, tail, tvar, varPart, vars, _ref;
      scope = o.scope;
      body = this.body;
      this.temps = [];
      ...
      if (!body.isEmpty()) {
        if (o.level > LEVEL_TOP || this.returns) {
          this.temps.push(rvar = scope.temporary('result'));
