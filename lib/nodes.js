(function(){
  ...
  exports.Class = Class = (function(){
    ...
    _ref.compileNode = function(o){
      var decl, name, lname, proto, i, exps, node, ctor, clas, _ref, _ref2, _len;
      if (this.title) {
  ...
  exports.Code = Code = (function(){
    ...
    _ref.compileNode = function(o){
      var pscope, sscope, scope, params, body, name, statement, tab, code, b, vars, asns, param, p, splats, ref, val, exps, wasEmpty, i, v, _ref, _i, _len;
      pscope = o.scope;
