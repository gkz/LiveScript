var Node, Negatable, Lines, Literal, Key, Index, Value, Call, Clone, Obj, Arr, Op, Assign, Import, Of, Existence, Fun, Class, Super, Parens, Splat, Statement, Throw, Return, While, For, Try, Switch, Case, If, Comment, Util, Scope, SE, UTILITIES, LEVEL_TOP, LEVEL_PAREN, LEVEL_LIST, LEVEL_COND, LEVEL_OP, LEVEL_ACCESS, TAB, IDENTIFIER, utility, lastNonComment, tabify, _ref, __extends = function(sub, sup){
...
exports.Assign = Assign = (function(_super){
  ...
  _proto.assertObj = function(){
    if (this.op !== ':') {
      throw SE('invalid assignment in an object: ' + this.show());
    }
    return this;
  };
...
exports.Fun = Fun = (function(_super){
  ...
  _proto.compileNode = function(o){
    var pscope, sscope, scope, params, body, name, tab, code, that, args, asns, prm, p, splatted, arg, asn, ref, val, exps, wasEmpty, dic, i, a, _ref, _i, _len;
    pscope = o.scope;
