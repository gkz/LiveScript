...
exports.Value = Value = (function(_super){
  ...
  _proto.unfoldBind = function(o){
    var i, ps, p, args, call, _ref, _len;
    for (i = 0, _len = (_ref = ps = this.tails).length; i < _len; ++i) {
      ...
      if (p.bind) {
        ...
        return Value(call, ps.slice(i + 1));
      }
    }
  };
...
exports.Call = Call = (function(_super){
  ...
  _proto.compileNode = function(o){
    ...
    if (that = Splat.compileArray(o, this.args)) {
...
exports.Parens = Parens = (function(_super){
  ...
  _proto.compileNode = function(o){
    var it;
    it = this.it;
    if (!this.keep && !this.newed && ((it instanceof Value || it instanceof Call || it instanceof Fun || it instanceof Parens || it instanceof Import) || it instanceof Op && o.level < LEVEL_OP)) {
