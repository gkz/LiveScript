(function(){
  ...
  exports.While = While = (function(){
    ...
    _ref = While.prototype, _ref.children = ["condition", "guard", "body"], _ref.isStatement = YES, _ref.containsPureStatement = function(){
      ...
      var body, i, node, ret, _ref;
      body = this.body;
      _ref = lastNonComment(body.expressions), node = _ref[0], i = _ref[1];
      if ((node != null ? node.value : void 0) === 'continue') {
        body.expressions.splice(i, 1);
      }
      ret = this.returns ? this.compilePush(o) : '';
      if (body.isEmpty()) {
        return '}' + ret;
      }
      if (this.guard) {
      ...
      return '\n' + body + '}' + ret;
    }, _ref.compilePush = function(o){
      var exps, last, res;
      exps = this.body.expressions;
