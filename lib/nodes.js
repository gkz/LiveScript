...
Node = (function(){
  ...
  prototype.compileBlock = function(o, name){
    var that, code, _ref;
...
exports.Statement = Statement = (function(_super){
  ...
  prototype.compileNode = function(it){
...
exports.Switch = Switch = (function(_super){
  ...
  prototype.children = ['switch', 'cases', 'default'];
  prototype.aSource = 'switch';
