(function(){
  ...
  exports.Base = Base = (function(){
    ...
    function Base(){}
    Base.name = "Base";
    _ref = Base.prototype, _ref.compile = function(o, level){
      ...
      return node;
    }, _ref.children = [], _ref.isStatement = NO, _ref.isPureStatement = NO, _ref.isComplex = YES, _ref.isChainable = NO, _ref.isAssignable = NO, _ref.isArray = NO, _ref.isObject = NO, _ref.assigns = NO, _ref.unwrap = THIS, _ref.unfoldSoak = NO, _ref.unfoldAssign = NO;
  ...
  exports.Call = Call = (function(){
    ...
    }, _ref.compileSplat = function(o, splatargs){
  ...
  exports.Import = Import = (function(){
    ...
    _ref = Import.prototype, _ref.children = ["left", "right"], _ref.compileNode = function(o){
      var acc, code, i, key, lref, node, props, ref, sub, val, _len, _ref, _ref2;
      if (!(this.right.isObject() && this.util === 'import')) {
        return Call(Value(Literal(utility(this.util))), [this.left, this.right]).compile(o);
      }
      this.temps = [];
      _ref = Value(this.left).cache(o, LEVEL_LIST), sub = _ref[0], lref = _ref[1];
      code = sub === lref ? '' : sub + ', ';
      for (i = 0, _len = (_ref = props = this.right.unwrap().properties).length; i < _len; ++i) {
        node = _ref[i];
  ...
  exports.Op = Op = (function(){
    ...
    _ref = Op.prototype, _ref.children = ["first", "second"], _ref.isUnary = function(){
      return !this.second;
    }, _ref.isChainable = function(){
      var _ref;
  ...
  exports.Switch = Switch = (function(){
    ...
    Switch.name = "Switch";
    _ref = Switch.prototype, _ref.children = ["subject", "cases", "otherwise"], _ref.isStatement = YES, _ref.makeReturn = function(){
      var cs, _i, _len, _ref;
  ...
  exports.If = If = (function(){
    ...
    If.name = "If";
    _ref = If.prototype, _ref.children = ["condition", "body", "elseBody"], _ref.bodyNode = function(){
      var _ref;
      return (_ref = this.body) != null ? _ref.unwrap() : void 0;
    }, _ref.elseBodyNode = function(){
      var _ref;
      return (_ref = this.elseBody) != null ? _ref.unwrap() : void 0;
    }, _ref.addElse = function(elseBody){
      if (this.isChain) {
