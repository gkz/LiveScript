(function(){
  ...
  Node = (function(){
    ...
    _proto.anaphorize = function(o, key){
      ...
      if (this.eachChild(HAS_THAT)) {
        this[key] = Assign(Literal('that'), this[key]);
      }
      delete this.children;
    };
    function HAS_THAT(it){
      return it.value === 'that' || (!it.childrenA ? it.eachChild(HAS_THAT) : void 8);
    }
    _proto.children = [];
    _proto.terminator = ';';
  ...
  exports.Lines = Lines = (function(_super){
    ...
    _proto.compileWithDeclarations = function(o){
      ...
      if (that = (_ref = this.scope) != null ? _ref.vars(o.globals) : void 8) {
        code += o.indent + that + ';\n';
      }
      return code + post;
    };
  ...
  exports.Value = Value = (function(_super){
    ...
    _proto.compileNode = function(o){
      var that, val, base, rest, t, _i, _ref, _len;
      if (that = this.unfoldAssign(o) || this.unfoldBind(o)) {
    ...
    _proto.unfoldSoak = function(o){
      var that, i, tail, fst, snd, ref, ifn, _ref, _len;
  ...
  exports.Case = Case = (function(_super){
    ...
    _proto.compileCase = function(o, tab, nobr){
      var br, code, add, test, t, exps, last, i, ft, that, _i, _ref, _len, _j, _ref2, _len2;
      code = br = '';
      add = function(it){
  ...
  exports.If = If = (function(_super){
    ...
    _proto.compileStatement = function(o){
      ...
      o.indent += TAB;
      if (that = Lines(this.then).compile(o)) {
        code += ("\n" + that + "\n") + this.tab;
      }
      code += '}';
      if (!this['else']) {
      ...
      return code + ' else ' + (this.chain
        ...
        : (that = this['else'].compile(o, LEVEL_TOP)) ? "{\n" + that + "\n" + this.tab + "}" : '{}');
    };
