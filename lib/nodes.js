(function(){
  ...
  exports.While = While = (function(){
    ...
    _ref = While.prototype, _ref.children = ["condition", "guard", "body"], _ref.isStatement = YES, _ref.addBody = function(_arg){
      ...
      return false;
    }, _ref.discontinue = function(){
      var i, node, nodes, _ref;
      _ref = lastNonComment(this.body.expressions), node = _ref[0], i = _ref[1], nodes = _ref[2];
  ...
  exports.For = For = (function(){
    ...
    _ref = For.prototype, _ref.children = ["source", "name", "from", "to", "step", "guard", "body"], _ref.compileNode = function(o){
      var bod, code, cond, eq, forPart, head, idx, item, lvar, ownPart, pvar, ret, scope, srcPart, step, svar, tail, tvar, vars, _ref;
      scope = o.scope;
      this.temps = [];
      if (idx = this.index) {
        scope.declare(idx);
      ...
      if (!(bod = this.body).isEmpty()) {
        this.discontinue();
        if (this.returns) {
          ret = this.makePush(o, bod);
        }
        if (this.guard) {
          bod = If(this.guard, bod, {
            'statement': 'statement'
          });
        }
  ...
  exports.Switch = Switch = (function(){
    ...
    _ref = Switch.prototype, _ref.children = ["switch", "cases", "default"], _ref.isStatement = YES, _ref.makeReturn = function(){
      ...
      var code, cs, i, stop, tab, _len, _ref;
      tab = this.tab;
      o.indent += TAB;
      ...
      for (i = 0, _len = (_ref = this.cases).length; i < _len; ++i) {
        ...
        if (!(lastNonComment(cs.body.expressions)[0] instanceof Return)) {
          code += o.indent + 'break;\n';
        }
      }
      if (this["default"]) {
