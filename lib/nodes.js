(function(){
  ...
  exports.Value = Value = (function(){
    ...
    _ref.isPureStatement = function(it){
      return !this.tails.length && this.head.isPureStatement(it);
    };
    _ref.assigns = function(it){
    ...
    _ref.compileNode = function(o){
      var asn, code, t, tails, val, _i, _len;
    ...
    _ref.substituteStar = function(o){
      var find, i, ref, star, sub, tail, _len, _ref, _ref2;
      find = function(it){
        switch (false) {
        case it.value !== '*':
          return it;
    ...
    _ref.unfoldSoak = function(o){
      var fst, i, ifn, ref, snd, tail, _len, _ref;
    ...
    _ref.unfoldAssign = function(o){
      var asn, i, lhs, rhs, tail, _len, _ref, _ref2;
  ...
  exports.While = While = (function(){
    ...
    _ref.isPureStatement = function(it){
      ...
      if ((_ref = lines[--i]) != null ? _ref.isPureStatement(it) : void 8) {
        return true;
      }
      ret = function(it){
  ...
  exports.Try = Try = (function(){
    ...
    _ref.isPureStatement = function(it){
      var _ref;
      return this.attempt.isPureStatement(it) || ((_ref = this.recovery) != null ? _ref.isPureStatement(it) : void 8);
    };
    _ref.makeReturn = function(it){
  ...
  exports.Parens = Parens = (function(){
    ...
    _ref.isPureStatement = function(it){
      return this.it.isPureStatement(it);
    };
    _ref.compileNode = function(o){
      var code, it;
      it = this.it;
  ...
  exports.Switch = Switch = (function(){
    ...
    _ref.isPureStatement = function(it){
      ...
      for (_i = 0, _len = (_ref = this.cases).length; _i < _len; ++_i) {
        cs = _ref[_i];
        if (cs.body.isPureStatement(it)) {
          return true;
        }
      }
      return (_ref = this["default"]) != null ? _ref.isPureStatement(it) : void 8;
    };
    _ref.makeReturn = function(it){
      var cs, _i, _len, _ref;
      for (_i = 0, _len = (_ref = this.cases).length; _i < _len; ++_i) {
  ...
  exports.If = If = (function(){
    ...
    _ref.isPureStatement = function(it){
      var _ref;
      return this.then.isPureStatement(it) || ((_ref = this["else"]) != null ? _ref.isPureStatement(it) : void 8);
    };
    _ref.makeReturn = function(it){
