...
Node = (function(){
  ...
  _proto.compileClosure = function(o){
    var that, fun, args, method, mentionsArgs;
    if (that = this.jumps()) {
    ...
    return Parens(Call.make(fun, args, method), true).compileNode(o);
  };
...
exports.Var = Var = (function(_super){
  ...
  _proto.varName = Var.prototype.show;
...
exports.Call = Call = (function(_super){
  ...
  Call.make = function(callee, args, method){
    var _ref;
    return Chain(callee).add((_ref = Call(args), _ref.method = method, _ref));
  };
  ...
  Call['let'] = function(fun){
    ...
    if (_ref = fun.bound, delete fun.bound, _ref) {
      fun.method = '.call';
      args.unshift(Literal('this'));
    }
    return Parens(this.make(fun, args));
  };
  return Call;
}(Node));
