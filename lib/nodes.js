(function(){
  ...
  Node = (function(){
    ...
    _ref.compileClosure = function(o){
      var func, args, val, mentionsArgs;
      if (this.jumps()) {
  ...
  exports.Import = Import = (function(){
    ...
    _ref.compileNode = function(o){
      var top, items, lref, sub, delim, space, code, node, com, dyna, val, key, acc, asn, _ref, _i, _len;
  ...
  exports.Assign = Assign = (function(){
    ...
    _ref.compileDestructuring = function(o){
      var left, items, olen, rite, rref, cache, list, code;
