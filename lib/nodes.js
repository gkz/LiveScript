(function() {
  ...
  exports.For = (function() {
    ...
    For.prototype.compileNode = function(o) {
      ...
      defPart += this.pluckDirectCall(o, name, index);
    ...
    For.prototype.pluckDirectCall = function(o, name, index) {
      var _len, a, args, base, call, code, fn, i, ref;
      if (!(!this.pattern && (call = last(this.body.expressions || [this.body])) instanceof Call && (code = call.variable) instanceof Code || code instanceof Value && code.base instanceof Code && [console.log(code)] && code.properties.length === 1 && code.properties[0].name.value === 'call')) {
        return '';
      }
      fn = code.base || code;
      ...
      this.body.expressions.splice(-1, 1, new Call(ref, args));
      return this.tab + new Assign(ref, fn).compile(o, LEVEL_TOP) + ';\n';
    };
    return For;
  })();
