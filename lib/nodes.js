(function(){
  ...
  var __importAll = function(obj, src){ for (var key in src) obj[key] = src[key]; return obj }, __extends = function(child, parent){
  ...
  exports.Obj = function(){
    ...
    Obj.prototype.compileNode = function(o){
      var code, i, idt, lastIndex, lastNonComment, prop, props, rest, _i, _len, _len2, _ref2;
      _ref2 = props = this.properties;
      for (i = 0, _len = _ref2.length; i < _len; i++) {
        prop = _ref2[i];
    ...
    Obj.prototype.compileDynamic = function(o, code, props){
      var acc, i, impt, key, oref, prop, ref, sp, val, _len, _ref2;
  ...
  exports.Op = function(){
    ...
    Op.prototype.isChainable = function(){
      var _ref2;
      return (_ref2 = this.operator) === "<" || _ref2 === ">" || _ref2 === ">=" || _ref2 === "<=" || _ref2 === "===" || _ref2 === "!==" || _ref2 === "==" || _ref2 === "!=";
    };
