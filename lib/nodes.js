(function(){
  var Accessor, Arr, Assign, Base, Call, Class, Closure, Code, Comment, Existence, Expressions, Extends, For, IDENTIFIER, If, Import, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NO, NUMBER, Obj, Op, Param, Parens, Push, Return, SIMPLENUM, Scope, Splat, Switch, TAB, THIS, TRAILING_WHITESPACE, Throw, Try, UTILITIES, Value, While, YES, compact, del, flatten, last, multident, utility, _ref;
  ...
  _ref = require('./helpers'), compact = _ref.compact, flatten = _ref.flatten, del = _ref.del, last = _ref.last;
  ...
  exports.Base = function(){
    ...
    Base.prototype.toString = function(idt, override){
      var child, children, name, _i, _len, _ref2, _result;
      idt != null ? idt : idt = '';
      children = function(){
  ...
  exports.Value = function(){
    ...
    Value.prototype.unfoldSoak = function(o){
      var fst, i, ifn, prop, ref, snd, _len, _ref2, _this;
    ...
    Value.prototype.unfoldAssign = function(o){
      var asn, i, lhs, prop, rhs, _len, _ref2, _ref3, _this;
      ...
      for (i = 0, _len = _ref2.length; i < _len; i++) {
        ...
        if (prop.assign) {
          prop.assign = false;
          _ref3 = new Value(this.base, this.properties.slice(0, i)).cacheReference(o), lhs = _ref3[0], rhs = _ref3[1];
  ...
  exports.Call = function(){
    ...
    Call.prototype.unfoldSoak = function(o){
      var call, ifn, left, rite, _i, _len, _ref2, _ref3;
      if (this.soak) {
        if (this.variable) {
    ...
    Call.prototype.compileNode = function(o){
      var arg, args, asn, call, code, vr, _i, _j, _len, _len2, _ref2, _ref3, _result;
      if (vr = this.variable) {
        _ref2 = this.digCalls();
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          call = _ref2[_i];
  ...
  exports.Import = function(){
    ...
    Import.prototype.compile = function(o){
      ...
      if (this.own) {
        args.push(new Literal(true));
      }
      return new Call(new Value(new Literal(utility('import'))), args).compile(o);
    };
    return Import;
  }();
  exports.Accessor = function(){
    ...
    Accessor.prototype.compile = function(o){
      var name, _ref2;
      return (_ref2 = (name = this.name.compile(o)).charAt(0)) === "\"" || _ref2 === "\'" ? "[" + name + "]" : "." + name;
    };
  ...
  exports.Obj = function(){
    ...
    Obj.prototype.compileNode = function(o){
      var code, i, idt, lastIndex, lastNonComment, prop, _i, _len, _len2, _ref2, _ref3, _ref4;
      _ref2 = this.properties;
      for (i = 0, _len = _ref2.length; i < _len; i++) {
        prop = _ref2[i];
        if ((prop.variable || prop).base instanceof Parens || prop instanceof Splat) {
          return this.compileDynamic(o, i);
        }
      }
      lastIndex = this.properties.length - 1;
      _ref3 = this.properties;
      for (_i = _ref3.length - 1; _i >= 0; _i--) {
        prop = _ref3[_i];
    ...
    Obj.prototype.compileDynamic = function(o, idx){
      var acc, code, i, key, obj, prop, ref, sp, val, _len, _ref2, _ref3;
  ...
  exports.Class = function(){
    ...
    Class.prototype.compileNode = function(o){
      var accs, applied, apply, className, code, constScope, ctor, extension, func, me, pname, prop, props, pvar, ref, ret, variable, _i, _len, _ref2, _ref3;
  ...
  exports.Assign = function(){
    ...
    Assign.prototype.compileNode = function(o){
      var isValue, match, name, val, value, variable, _, _ref2;
      ...
      if (!(this.access || isValue && (variable.namespaced || variable.hasProperties()))) {
        o.scope.find(name);
      }
    ...
    Assign.prototype.compileAccess = function(o){
      var acc, base, call, code, left, rite, val, _ref2;
      val = this.value;
  ...
  exports.Code = function(){
    ...
    Code.prototype.compileNode = function(o){
      var close, code, comm, exprs, func, i, idt, open, p, param, ref, scope, sharedScope, splats, v, vars, wasEmpty, _i, _j, _len, _len2, _len3, _ref2, _ref3, _result, _this;
  ...
  exports.Op = function(){
    ...
    Op.prototype.compileMultiIO = function(o){
      var code, i, item, ref, sub, tests, _len, _ref2, _ref3, _result;
      _ref2 = this.first.cache(o, LEVEL_OP), sub = _ref2[0], ref = _ref2[1];
      tests = function(){
        _ref3 = this.second.base.objects;
        _result = [];
  ...
  exports.In = function(){
    ...
    In.prototype.compileOrTest = function(o){
      var cmp, cnj, code, i, item, ref, sub, tests, _len, _ref2, _ref3, _ref4, _result;
  ...
  exports.Parens = function(){
    ...
    Parens.prototype.compileNode = function(o){
      ...
      if (!this.newed && ((expr instanceof Value || expr instanceof Call || expr instanceof Code || expr instanceof Parens) || o.level < LEVEL_OP && expr instanceof Op)) {
  ...
  exports.For = function(){
    ...
    For.prototype.pluckDirectCall = function(o, body, name, index){
      var a, args, base, defs, expr, fn, i, idx, ref, val, _len, _len2, _ref2, _ref3, _ref4;
      defs = '';
      ...
      for (idx = 0, _len = _ref2.length; idx < _len; idx++) {
        ...
        if ((expr = expr.unwrapAll()) instanceof Call) {
          ...
          if (!(val instanceof Code && !expr.args.length || val instanceof Value && val.base instanceof Code && val.properties.length === 1 && ((_ref3 = val.properties[0].name) != null ? _ref3.value : void 0) === 'call')) {
            continue;
          }
          fn = val.base || val;
          ...
          if (val.base) {
            _ref4 = [base, val], val.base = _ref4[0], base = _ref4[1];
  ...
  exports.Switch = function(){
    ...
    Switch.prototype.compileNode = function(o){
      var block, body, code, cond, conditions, expr, i, idt, tab, _i, _j, _len, _len2, _ref2, _ref3, _ref4, _ref5;
      tab = this.tab;
      idt = o.indent = this.idt(1);
      code = tab + ("switch (" + (((_ref2 = this.subject) != null ? _ref2.compile(o, LEVEL_PAREN) : void 0) || false) + ") {\n");
  ...
  exports.If = function(){
    ...
    If.prototype.isStatement = function(o){
      var _ref2;
      return this.statement || (o != null ? o.level : void 0) === LEVEL_TOP || this.bodyNode().isStatement(o) || ((_ref2 = this.elseBodyNode()) != null ? _ref2.isStatement(o) : void 0);
    };
    ...
    If.prototype.compileExpression = function(o){
      var code, _ref2;
      code = this.condition.compile(o, LEVEL_COND) + ' ? ' + this.bodyNode().compile(o, LEVEL_LIST) + ' : ' + (((_ref2 = this.elseBodyNode()) != null ? _ref2.compile(o, LEVEL_LIST) : void 0) || 'void 0');
      return o.level >= LEVEL_COND ? "(" + code + ")" : code;
    };
