(function(){
  var Accessor, Arr, Assign, Base, Call, Case, Class, Closure, Code, Comment, Existence, Expressions, Extends, For, IDENTIFIER, If, Import, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, NUMBER, Obj, Op, Param, Parens, Push, RETURN, Return, SIMPLENUM, Scope, Splat, Switch, TAB, THIS, TRAILING_WHITESPACE, Throw, Try, UTILITIES, Value, While, YES, del, multident, utility, __importAll = function(obj, src){
  ...
  exports.Code = (function(){
    ...
    Code.prototype.compileNode = function(o){
      var close, code, comm, exps, func, i, idt, lit, open, p, param, ref, scope, splats, v, val, vars, wasEmpty, _i, _j, _len, _len2, _ref, _ref2, _result;
      o.scope = scope = del(o, 'sharedScope') || new Scope(o.scope, this.body, this);
      o.indent += TAB;
      delete o.bare;
      delete o.globals;
      vars = [];
