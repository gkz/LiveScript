(function(){
  ...
  exports.Assign = Assign = (function(){
    ...
    _ref.compileDestructuring = function(o){
      ...
      list = this['destruct' + left.constructor.name](o, objects, rite);
      if (rref) {
        o.scope.free(rref);
      }
      if (cache) {
    ...
    _ref.destructObj = function(o, nodes, rite){
      var acc, dyna, key, lr, node, val, _i, _len, _ref, _results = [];
      for (_i = 0, _len = nodes.length; _i < _len; ++_i) {
        node = nodes[_i];
        dyna = false;
        if (node instanceof Assign) {
        ...
        val = Value(lr || (lr = Literal(rite)), [(acc ? Accessor : Index)(key)]);
