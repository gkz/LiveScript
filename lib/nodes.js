(function(){
  ...
  exports.Assign = Assign = (function(){
    ...
    _ref = Assign.prototype, _ref.children = ["variable", "value"], _ref.assigns = function(name){
      return this[this.op === ':' ? 'value' : 'variable'].assigns(name);
    }, _ref.unfoldSoak = function(o){
      return If.unfoldSoak(o, this, 'variable');
    }, _ref.unfoldAssign = function(){
      return this.access && this;
    }, _ref.compileNode = function(o){
      var code, match, name, val, value, variable, _ref;
      ...
      for (i = 0, _len = objects.length; i < _len; ++i) {
        ...
        assigns.push(Assign(obj, val, this.op).compile(o, LEVEL_LIST));
      }
      if (ref) {
        o.scope.free(ref);
      }
      ...
      return Op(this.op.slice(0, -1), left, Assign(rite, this.value, ':=')).compile(o);
