...
exports.Block = Block = (function(_super){
  ...
  _proto.compileRoot = function(options){
    var o, bare, first, shebang, code, _ref;
...
exports.Obj = Obj = (function(_super){
  ...
  _proto.compileDynamic = function(o, code, items){
    ...
    o.indent = this.tab;
    if (items.length < 2) {
      return Import(JS(code), Obj(items)).compile(o);
    }
    code = "" + (oref = o.scope.temporary('obj')) + " = " + code + ", " + Import(Var(oref), Obj(items)).compile(o, LEVEL_PAREN);
    o.scope.free(oref);
