(function(){
    ...
    _ref = Import.prototype, _ref.children = ["left", "right"], _ref.compileNode = function(o){
      ...
      for (_i = 0, _len = nodes.length; _i < _len; ++_i) {
        ...
        if (node instanceof Assign) {
          val = node.right, (_ref = node.left, acc = _ref.base, _ref);
  ...
  exports.Assign = Assign = (function(){
    ...
    _ref = Assign.prototype, _ref.children = ["left", "right"], _ref.assigns = function(name){
      ...
      var acc, assigns, code, i, idx, isObject, ivar, obj, objects, olen, ref, rest, right, splat, top, val, vvar, _len, _ref, _ref2;
      top = !o.level;
      right = this.right;
      ...
      if (top && olen === 1 && !((obj = objects[0]) instanceof Splat)) {
        if (obj instanceof Assign) {
          _ref = obj, obj = _ref.right, (_ref2 = _ref.left, idx = _ref2.base, _ref2);
        } else {
      ...
      var left, rite, _ref;
      _ref = this.left.cacheReference(o), left = _ref[0], rite = _ref[1];
