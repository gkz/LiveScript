(function(){
  ...
  exports.Expressions = Expressions = (function(){
    ...
    _ref.compileNode = function(o){
      ...
      for (_i = 0, _len = (_ref = this.expressions).length; _i < _len; ++_i) {
        ...
        if (top) {
          node.front = true;
          code = node.compile(o);
          codes.push(node.isStatement(o) ? code : this.tab + code + node.terminater);
        } else {
    ...
    _ref.compileWithDeclarations = function(o){
      var code, exp, i, post, rest, scope, vars, _len, _ref, _ref2;
      code = post = '';
  ...
  exports.Literal = Literal = (function(){
    ...
    function Literal(_arg){
      var isPureStatement, _ref, _this = new _ctor;
      _this.value = _arg;
      if ((_ref = _this.value) === "break" || _ref === "continue" || _ref === "debugger") {
        isPureStatement = YES;
      }
      return _this;
  ...
  exports.Call = Call = (function(){
    ...
    _ref = Call.prototype;
    _ref.children = ["variable", "args"];
    _ref.newInstance = function(){
      this["new"] = 'new ';
      return this;
    };
  ...
  exports.Accessor = Accessor = (function(){
    ...
    function _ctor(){} _ctor.prototype = Accessor.prototype;
  ...
  exports.Class = Class = (function(){
    ...
    _ref.children = ["variable", "parent", "body"];
    _ref.compileNode = function(o){
  ...
  exports.Assign = Assign = (function(){
    ...
    function Assign(_arg, _arg2, _arg3, _arg4){
      var _this = new _ctor;
      _this.left = _arg;
      _this.right = _arg2;
      _this.op = _arg3 != null ? _arg3 : '=';
      _this.logic = _arg4 != null ? _arg4 : _this.op.logic;
      _this.op += '';
      return _this;
    } Assign.name = "Assign";
    ...
    _ref.compileDestructuring = function(o){
      var acc, assigns, code, dyna, i, idx, isObject, ivar, obj, objects, olen, ref, rest, splat, top, val, vvar, _len, _ref;
      top = !o.level;
      ...
      if (top && olen === 1 && !((obj = objects[0]) instanceof Splat)) {
        ...
        acc = !dyna && IDENTIFIER.test(idx.unwrap().value || 0);
        val = Value(this.right).append((acc ? Accessor : Index)(idx));
        return Assign(obj, val, this.op).compile(o);
      }
      vvar = this.right.compile(o, LEVEL_LIST);
      assigns = [];
      splat = false;
      ...
      for (i = 0, _len = objects.length; i < _len; ++i) {
        ...
        if (!splat && obj instanceof Splat) {
          ...
          acc = isObject ? !dyna && IDENTIFIER.test(idx.unwrap().value || 0) : (idx = Literal(splat || i), false);
  ...
  exports.Code = Code = (function(){
    ...
    function Code(_arg, _arg2, arrow){
      var _this = new _ctor;
