(function(){
  ...
  exports.Literal = Literal = (function(){
    ...
    function Literal(value, reserved){
      ...
      if (value === 'break' || value === 'continue' || value === 'debugger') {
        _this.isStatement = YES;
        _this.makeReturn = THIS;
      } else if (reserved) {
    ...
    _ref.jumps = function(it){
      return this.isStatement() && !(it && (it.loop || it.block && this.value !== 'continue'));
    };
  ...
  exports.While = While = (function(){
    ...
    _ref.compileBody = function(o){
      var body, exps, last, i, ret, res, code, _ref;
      body = this.body;
