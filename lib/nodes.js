  ...
  exports.Call = Call = (function(){
    ...
    _ref.compileNode = function(o){
      ...
      if (this.splat) {
        ...
        return this.variable.compile(o, LEVEL_ACCESS) + (".apply(" + this.args[0].value + ", " + this.args[1].value + ")");
      }
  ...
  exports.Obj = Obj = (function(){
    ...
    _ref.compileNode = function(o){
      ...
      for (i = 0, _len = props.length; i < _len; ++i) {
        prop = props[i];
        if (!(prop instanceof Splat || (prop.left || prop).base instanceof Parens)) continue;
