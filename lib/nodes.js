(function(){
  ...
  exports.For = For = (function(){
    ...
    _ref.compileNode = function(o){
      ...
      this.pluckDirectCalls(o, this.body.expressions, this.name, this.index);
    ...
    _ref.pluckDirectCalls = function(o, exps, name, index){
      ...
      for (idx = 0, _len = exps.length; idx < _len; ++idx) {
        ...
        if ((exp = exp.unwrapAll()) instanceof Call) {
          ...
          if (name) {
            args.push(Literal(name.isComplex()
              ? this.nref || (this.nref = (this.temps.push(nref = o.scope.temporary('ref')), nref))
              : name.value));
