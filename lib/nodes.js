...
exports.Block = Block = (function(_super){
  ...
  _proto.compile = function(o, level){
    var codes, node, code, _i, _ref, _len;
    ...
    for (_i = 0, _len = (_ref = this.lines).length; _i < _len; ++_i) {
      ...
      if (level) {
        ...
        code = (node.front = true, node).compile(o, level);
        if (!node.isStatement(o)) {
  ...
  _proto.compileWithDeclarations = function(o){
    ...
    if (post = (this.lines.length ? this.compile(o) : '')) {
      code && (code += '\n');
    }
...
exports.Fun = Fun = (function(_super){
  ...
  _proto.compileNode = function(o){
    ...
    code += '}';
    if (this.plucked) {
      sscope.assign(ref = sscope.temporary('fn'), code);
      return ref;
    }
...
exports.Parens = Parens = (function(_super){
  ...
  _proto.compileNode = function(o){
    ...
    if (!(this.keep || this.newed)) {
      if ((it instanceof Atom || it instanceof Chain || it instanceof Fun || it instanceof Parens || it instanceof List) || it instanceof Op && o.level < LEVEL_OP + (PREC[it.op] || PREC.unary)) {
