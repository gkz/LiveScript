(function(){
  var Scope, Node, Lines, Literal, Statement, Throw, Return, Value, Call, Access, Index, Obj, Arr, Op, Assign, Import, Of, Existence, Fun, Class, Extends, Super, Parens, Splat, While, For, Try, Switch, Case, If, Comment, UTILITIES, LEVEL_TOP, LEVEL_PAREN, LEVEL_LIST, LEVEL_COND, LEVEL_OP, LEVEL_ACCESS, TAB, IDENTIFIER, METHOD_DEF, utility, multident, lastNonComment, __extends = function(sub, sup){
  ...
  exports.While = While = (function(_super){
    ...
    _proto.compileNode = function(o){
      ...
      test = this.negated
        ? this.test.invert()
        : this.test;
      code = (test != null ? test.compile(o, LEVEL_PAREN) : void 8) || 'true';
