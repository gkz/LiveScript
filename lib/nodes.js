(function(){
  ...
  exports.Code = (function(){
    ...
    Code.prototype.compileNode = function(o){
      var close, code, comm, exps, func, i, idt, lit, open, p, param, ref, scope, sharedScope, splats, v, val, vars, wasEmpty, _i, _j, _len, _len2, _ref, _ref2, _result;
      ...
      if (exps.length) {
        (_ref = this.body.expressions).splice.apply(_ref, [0, 0].concat(__slice.call(exps)));
      }
  ...
  exports.For = (function(){
    ...
    For.prototype.compileNode = function(o){
      var body, code, cond, defPart, eq, forPart, guardPart, idt, index, ivar, lvar, name, namePart, pattern, pvar, retPart, rvar, scope, sourcePart, step, svar, tail, tvar, varPart, vars, _ref;
      scope = o.scope;
      body = this.body;
      this.temps = [];
