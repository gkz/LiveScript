  ...
  exports.Obj = Obj = (function(){
    ...
    _ref.compileNode = function(o){
      ...
      for (_i = 0, _len = items.length; _i < _len; ++_i) {
        ...
        code += idt + (node["this"] ? (key = node.properties[0].name.compile(o), key + ': ' + node.compile(o, LEVEL_LIST)) : node instanceof Assign ? (key = node.left.compile(o), node.compile(o)) : (key = node.compile(o, LEVEL_LIST)) + ': ' + key);
        if (dic[key + 0]) {
