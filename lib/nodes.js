(function(){
  ...
  exports.Statement = Statement = (function(){
    var _ref;
    __extends(Statement, Node);
    function _ctor(){} _ctor.prototype = Statement.prototype;
    function Statement(name){
      var _this = new _ctor;
      _this.name = name;
      return _this;
    } Statement.name = 'Statement';
    _ref = Statement.prototype;
    _ref.show = function(){
      return this.name;
    };
  ...
  exports.Value = Value = (function(){
    ...
    _ref.unfoldBind = function(o){
      var i, ps, p, ctx, ref, fun, _ref, _len, _ref2;
    ...
    _ref.compileNode = function(o){
      ...
      for (_i = 0, _len = items.length; _i < _len; ++_i) {
        ...
        if (dyna = node instanceof Parens) {
          _ref = node.it.cache(o), key = _ref[0], val = _ref[1];
  ...
  exports.Index = Index = (function(){
    ...
    _ref.children = ['index'];
    _ref.show = Access.prototype.show;
    _ref.compile = function(o){
  ...
  exports.Class = Class = (function(){
    ...
    _ref.children = ['title', 'sup', 'fun'];
    _ref.compileNode = function(o){
      var fun, lines, decl, name, lname, proto, i, node, ctor, clas, _ref, _ref2, _len;
      fun = this.fun;
      ...
      ctor.clas = false;
      if (this.sup) {
        lines.unshift(Extends(lname, this.sup));
      }
      lines.push(lname);
      clas = Call(fun, []);
  ...
  exports.Fun = Fun = (function(){
    var paramName, _ref;
    __extends(Fun, Node);
    function _ctor(){} _ctor.prototype = Fun.prototype;
  ...
  exports.Op = Op = (function(){
    ...
    _ref.show = Assign.prototype.show;
    _ref.invert = function(){
      var op, _ref;
  ...
  exports.Of = Of = (function(){
    ...
    _ref.compileNode = function(o){
      ...
      _ref = this.item.cache(o, lvl), sub = _ref[0], ref = _ref[1];
      if (arr) {
        _ref = this.negated
          ? [' !== ', ' && ']
  ...
  exports.Existence = Existence = (function(){
    ...
    _ref.children = ['it'];
    _ref.show = Of.prototype.show;
    _ref.invert = Of.prototype.invert;
    _ref.compileNode = function(o){
      var code;
  ...
  exports.If = If = (function(){
    ...
    _ref.compileStatement = function(o){
      ...
      if (this.post && this.then instanceof Return && !this.then.it) {
        _ref = this['if'].cache(o), this['if'] = _ref[0], ref = _ref[1];
