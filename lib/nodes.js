(function(){
  var Scope, Node, Lines, Literal, Statement, Throw, Return, Value, Call, Access, Index, Obj, Arr, Op, Assign, Import, Of, Existence, Fun, Class, Super, Parens, Splat, While, For, Try, Switch, Case, If, Comment, Util, UTILITIES, LEVEL_TOP, LEVEL_PAREN, LEVEL_LIST, LEVEL_COND, LEVEL_OP, LEVEL_ACCESS, TAB, IDENTIFIER, METHOD_DEF, utility, multident, lastNonComment, __extends = function(sub, sup){
