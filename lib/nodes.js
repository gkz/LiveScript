(function(){
  var Accessor, Arr, Assign, Base, Call, Class, Closure, Code, Comment, Existence, Expressions, Extends, For, IDENTIFIER, IS_STRING, If, Import, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, NO, NUMBER, Obj, Op, Param, Parens, Push, Return, SIMPLENUM, Scope, Splat, Switch, TAB, THIS, TRAILING_WHITESPACE, Throw, Try, UTILITIES, Value, While, YES, _ref, compact, del, ends, flatten, last, multident, starts, utility;
  ...
  exports.Base = function(){
    ...
    Base.prototype.containsPureStatement = function(){
      return this.isPureStatement() || this.contains(function(node, func){
        return func(node) || (node instanceof While || node instanceof For ? function(it){
  ...
  exports.For = function(){
    ...
    For.prototype.pluckDirectCall = function(o, body, name, index){
      var _len, _len2, _ref2, _ref3, _ref4, a, args, base, defs, expr, fn, i, idx, ref, val;
      defs = '';
