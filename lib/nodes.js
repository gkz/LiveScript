(function(){
  var Node, Negatable, Lines, Literal, Statement, Throw, Return, Value, Call, Access, Index, Obj, Arr, Op, Assign, Import, Of, Existence, Fun, Class, Super, Parens, Splat, While, For, Try, Switch, Case, If, Comment, Util, Scope, UTILITIES, LEVEL_TOP, LEVEL_PAREN, LEVEL_LIST, LEVEL_COND, LEVEL_OP, LEVEL_ACCESS, TAB, IDENTIFIER, METHOD_DEF, utility, multident, lastNonComment, _ref, __extends = function(sub, sup){
  ...
  Node = (function(){
    var HAS_THAT, _proto = Node.prototype;
    ...
    _proto.anaphorize = function(o, key){
      this.children = this.childrenA;
      if (this.traverseChildren(HAS_THAT)) {
        this[key] = Assign(Literal('that'), this[key]);
      }
      delete this.children;
    };
    HAS_THAT = function(it){
      if (it.childrenA) {
        return false;
      } else {
        return it.value === 'that' || it.traverseChildren(HAS_THAT);
      }
    };
    _proto.children = [];
    _proto.terminator = ';';
  ...
  exports.Call = Call = (function(_super){
    ...
    _proto.unfoldSoak = function(o){
      var ifn, left, rite, call, _ref, _i, _len;
      if (this.soak) {
  ...
  exports.Arr = Arr = (function(_super){
    ...
    _proto.compileNode = function(o){
      ...
      if (that = Splat.compileArray(o, this.items)) {
        return that;
      }
      o.indent += TAB;
      code = (function(){
  ...
  exports.Parens = Parens = (function(_super){
    ...
    _proto.compileNode = function(o){
      var it;
      it = this.it;
      if (!this.keep && ((it instanceof Value || it instanceof Call || it instanceof Fun || it instanceof Parens || it instanceof Import) || o.level < LEVEL_OP && it instanceof Op)) {
  ...
  exports.While = While = (function(_super){
    ...
    _proto.childrenA = ['body'];
    _proto.show = Negatable.show;
    _proto.isStatement = YES;
  ...
  exports.Switch = Switch = (function(_super){
    ...
    _proto.childrenA = ['cases', 'default'];
    _proto.isStatement = YES;
    ...
    _proto.compileNode = function(o){
      var tests, i, cond, tab, code, stop, cs, def, _ref, _len;
      cond = (function(){
        var _i, _ref, _len, _ref2;
        if (this['switch']) {
          this.anaphorize(o, 'switch');
          return this['switch'].compile(o, LEVEL_PAREN);
        } else {
          for (_i = 0, _len = (_ref = this.cases).length; _i < _len; ++_i) {
            tests = _ref[_i].tests;
            for (i in _ref2 = tests) if (__owns.call(_ref2, i)) {
  ...
  exports.Util = Util = (function(_super){
    ...
    _proto.show = Statement.prototype.show;
    _proto.compile = function(){
      return utility(this.name);
    };
    Util.Clone = function(it, mixin){
      return Parens(Import(Call(Value(Util('clone')), [it]), mixin));
    };
    Util.Extends = function(sub, sup){
      return Call(Value(Util('extends')), [sub, sup]);
    };
    return Util;
  }(Node));
  __importAll(exports, {
  ...
  _ref.vars = function(){
    var usr, tmp, asn, name, type, _i, _ref, _len, _ref2;
    usr = [];
    tmp = [];
    asn = [];
