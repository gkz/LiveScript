...
exports.Call = Call = (function(_super){
  ...
  _proto.compileNode = function(o){
    ...
    if (!callee.isCallable()) {
      callee.carp(callee.compile(o, LEVEL_ACCESS) + ' // invalid callee');
    }
    if (this.thisplat) {
      if (this['new']) {
...
exports.Obj = Obj = (function(_super){
  ...
  _proto.compileDynamic = function(o, code, items){
    return Import(JS(code), Obj(items)).compile((o.indent = this.tab, o));
  };
  return Obj;
}(List));
...
exports.Assign = Assign = (function(_super){
  ...
  _proto.compileNode = function(o){
    ...
    if (!left.isAssignable()) {
      left.carp(left.compile((o.indent = '', o), LEVEL_LIST) + " // invalid assignee");
    }
...
exports.Fun = Fun = (function(_super){
  ...
  _proto.compileNode = function(o){
    ...
    if (this.statement) {
      if (!name) {
        this.carp('nameless function');
      }
      if (o.block.scope !== pscope) {
        this.carp('function declaration under a statement');
      }
...
exports.Super = Super = (function(_super){
  ...
  _proto.compile = function(o){
    ...
    if (!fun) {
      this.carp('super outside of a function');
    }
