var Node, Negatable, Lines, Literal, Key, Index, Value, Call, Clone, Obj, Arr, Op, Assign, Import, Of, Existence, Fun, Class, Super, Parens, Splat, Statement, Throw, Return, While, For, Try, Switch, Case, If, Comment, Util, Scope, UTILITIES, LEVEL_TOP, LEVEL_PAREN, LEVEL_LIST, LEVEL_COND, LEVEL_OP, LEVEL_ACCESS, TAB, IDENTIFIER, METHOD_DEF, utility, lastNonComment, tabify, _ref, __extends = function(sub, sup){
...
exports.For = For = (function(_super){
  ...
  _proto.pluckDirectCalls = function(o){
    ...
    return this.body.eachChild(dig = function(it){
      ...
      fn = fn.compile((o.indent = '', o), LEVEL_LIST);
      o.scope.assign(ref, tabify(fn, o.indent = _this.tab));
    });
  };
  return For;
}(While));
