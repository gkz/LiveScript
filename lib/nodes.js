...
exports.Key = Key = (function(_super){
  ...
  function Key(name, reserved){
    var _this = new _ctor;
    reserved || (reserved = name.reserved);
    name += '';
    _this.name = name;
...
exports.Call = Call = (function(_super){
  ...
  function Call(callee, args, sym){
    ...
    if (args.length === 1 && args[0] instanceof Splat && args[0].it.isEmpty()) {
      _this.splat = true;
      args = [Literal('this'), Var('arguments')];
    }
    _this.args = args;
    _this.soak = sym === '?(';
    return _this;
...
exports.Assign = Assign = (function(_super){
  ...
  _proto.compileNode = function(o){
    ...
    if (!left.isAssignable()) {
      throw SE(left.L(left.compile((o.indent = '', o), LEVEL_LIST) + ' // invalid assignment'));
    }
...
exports.Parens = Parens = (function(_super){
  ...
  _proto.compileNode = function(o){
    ...
    if (!(this.keep || this.newed)) {
      if ((it instanceof Atom || it instanceof Value || it instanceof Call || it instanceof Fun || it instanceof Parens) || it instanceof Op && o.level < LEVEL_OP) {
