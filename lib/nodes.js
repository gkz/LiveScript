(function(){
  ...
  exports.Call = Call = (function(){
    ...
    _ref.compileNode = function(o){
      ...
      if (this.args.splat) {
        ...
        fn = this["super"] ? this.superReference(o) : this.variable.compile(o, LEVEL_ACCESS);
        return fn + (".apply(" + this.args[0].value + ", " + this.args[1].value + ")");
      }
  ...
  exports.Parens = Parens = (function(){
    ...
    _ref.makeReturn = function(){
      return this.expressions.makeReturn();
    };
    _ref.isComplex = function(){
  ...
  exports.Case = Case = (function(){
    ...
    _ref.makeReturn = function(){
      var lnc;
      lnc = lastNonComment(this.body.expressions)[0];
      if (lnc && lnc.value !== 'fallthrough') {
