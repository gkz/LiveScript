(function(){
  ...
  exports.Value = Value = (function(){
    ...
    _ref.cacheReference = function(o){
      ...
      return [base.add(name), Value(bref || base.base, [nref || name])];
    };
    _ref.compileNode = function(o){
  ...
  exports.Parens = Parens = (function(){
    ...
    _ref.makeReturn = function(it){
      return this.lines.makeReturn(it);
    };
    _ref.isComplex = function(){
      return this.lines.isComplex();
    };
    _ref.isStatement = function(){
      return this.lines.isStatement();
    };
    _ref.isPureStatement = function(){
      return this.lines.isPureStatement();
    };
    _ref.compileNode = function(o){
      var code, expr;
      (expr = this.lines.unwrap()).front = this.front;
