var Node, Negatable, Block, Atom, Literal, Var, Key, Index, Value, Call, Clone, List, Obj, Arr, Op, Assign, Import, Of, Existence, Fun, Class, Super, Parens, Splat, Statement, Throw, Return, While, For, Try, Switch, Case, If, JS, Util, SE, UTILITIES, LEVEL_TOP, LEVEL_PAREN, LEVEL_LIST, LEVEL_COND, LEVEL_OP, LEVEL_ACCESS, PREC, TAB, IDENTIFIER, _ref, __import = function(obj, src){
  ...
  _proto.compileUnary = function(o){
    ...
    case '--':
      if (first instanceof Var && !o.scope.check(first.value, true)) {
        throw SE(this.L("modification of undeclared variable \"" + first.value + "\""));
      }
    }
...
exports.Existence = Existence = (function(_super){
  ...
  _proto.compileNode = function(o){
    ...
    op = node instanceof Var && !o.scope.check(code, true)
