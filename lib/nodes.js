...
exports.Assign = Assign = (function(_super){
  ...
  _proto.compileNode = function(o){
    var left, name, right, that, val, code;
  ...
  _proto.transleft = function(o){
    var left, base, items, sub, ref, i, node, key, k, _ref, _len, _ref2;
    left = this.left;
    if (left.mixin) {
      base = left.base, items = left.mixin.items;
      if (items.length > 1) {
        _ref = base.cache(o), sub = _ref[0], ref = _ref[1];
        if (sub !== ref) {
          this.temps = [ref.value];
        }
      } else {
      ...
      for (i = 0, _len = items.length; i < _len; ++i) {
        ...
        if (!(node instanceof Comment)) {
          ...
          if (node instanceof Assign) {
            ...
            items[i] = Assign(node = node.asKey(), Value(base, [Index(node)]));
          }
        }
      }
      left = left.mixin;
      ...
      _ref = left.cache(o), sub = _ref[0], ref = _ref[1];
      if (sub !== ref) {
        this.temps = [ref.value];
      }
      left = Arr((function(){
...
exports.Util = Util = (function(_super){
  ...
  Util.Clone = function(base, mixin){
    var _ref;
    return _ref = Parens(Import(Call(Value(Util('clone')), [base]), mixin)), _ref.base = base, _ref.mixin = mixin, _ref;
  };
