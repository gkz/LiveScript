(function(){
  var Node, Negatable, Lines, Literal, Key, Index, Value, Call, Obj, Arr, Op, Assign, Import, Of, Existence, Fun, Class, Super, Parens, Splat, Statement, Throw, Return, While, For, Try, Switch, Case, If, Comment, Util, Scope, UTILITIES, LEVEL_TOP, LEVEL_PAREN, LEVEL_LIST, LEVEL_COND, LEVEL_OP, LEVEL_ACCESS, TAB, IDENTIFIER, METHOD_DEF, utility, lastNonComment, _ref, __extends = function(sub, sup){
  ...
  exports.Assign = Assign = (function(_super){
    ...
    _proto.destructObj = function(o, nodes, rite){
      var node, splat, key, lr, val, _i, _len, _ref, _results = [];
