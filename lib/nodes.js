(function(){
  var Accessor, Arr, Assign, Base, Call, Class, Closure, Code, Comment, Existence, Expressions, Extends, For, IDENTIFIER, IS_STRING, If, Import, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, NO, NUMBER, Obj, Op, Param, Parens, Push, Return, SIMPLENUM, Scope, Splat, Switch, TAB, THIS, TRAILING_WHITESPACE, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, flatten, last, multident, starts, utility, _ref;
  ...
  _ref = require('./helpers'), compact = _ref.compact, flatten = _ref.flatten, del = _ref.del, starts = _ref.starts, ends = _ref.ends, last = _ref.last;
  ...
  exports.Op = function(){
    ...
    Op.prototype.compileUnary = function(o){
      ...
      if ((op === 'new' || op === 'typeof' || op === 'delete' || op === 'void') || (op === '+' || op === '-') && this.first instanceof Op && this.first.operator === op) {
        parts.push(' ');
      }
