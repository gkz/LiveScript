...
var lexer, parser, ast, SourceNode, path;
lexer = require('./lexer');
...
exports.compile = function(code, options){
  var result, ast, output, filename, mapPath, ref$, e, that;
    ...
    if (options.json) {
      ...
      if (options.map && options.map !== 'none') {
        ...
        if ((ref$ = options.map) === 'linked' || ref$ === 'debug') {
          result.code += "\n//# sourceMappingURL=" + path.relative(path.dirname(filename), mapPath) + "\n";
        } else {
