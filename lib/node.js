...
module.exports = function(Coco){
  ...
  Coco.run = function(code, options){
    ...
    root.filename = (that = options.filename, delete options.filename, that) ? (root.paths = root.constructor._nodeModulePaths(path.dirname(that)), process.argv[1] = path.resolve(that)) : '.';
