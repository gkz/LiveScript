...
var LiveScript, path, fs, util, prelude, each, lines, unlines, take, dasherize, fileExists, dasherizeVars;
LiveScript = require('..');
path = require('path');
fs = require('fs');
util = require('util');
prelude = require('prelude-ls'), each = prelude.each, lines = prelude.lines, unlines = prelude.unlines, take = prelude.take, dasherize = prelude.dasherize;
