...
bnf =
  ...
  Chain:
    ...
    o '[ Expression LoopHeads ]'  -> Chain L 1 4 ($3.0.makeComprehension $2, $3.slice 1)
    o '[ Expression LoopHeads DEDENT ]'  -> Chain L 1 5 ($3.0.makeComprehension $2, $3.slice 1)
    ...
    , -> Chain(L 3 Chain Var \flip$ .add L 3 Call [$3]).flipIt!add L 5 Call [$5]
    ...
    , -> Chain L 1 2 new For(kind: $1, source: $2, body: $3, ref: true)addBody $3
  ...
  Line:
    ...
    , -> Call.back $2, $6, $5.charAt(1) is \~, $5.length is 3, /!/.test($5), /\*/.test($5)
